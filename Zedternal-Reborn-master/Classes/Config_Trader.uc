...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < class'ZedternalReborn.Config_Base'.const.CurrentVersion)
	{
		...
		default.Trader_MaxWeapon.Normal = 1052;
		default.Trader_MaxWeapon.Hard = 1052;
		default.Trader_MaxWeapon.Suicidal = 1052;
		default.Trader_MaxWeapon.HOE = 1052;
		default.Trader_MaxWeapon.Custom = 1052;
		default.Trader_StartingWeaponNumber.Normal = 3;
		default.Trader_StartingWeaponNumber.Hard = 3;
		default.Trader_StartingWeaponNumber.Suicidal = 3;
		default.Trader_StartingWeaponNumber.HOE = 3;
		default.Trader_StartingWeaponNumber.Custom = 3;
		default.Trader_NewWeaponEachWave.Normal = 3;
		default.Trader_NewWeaponEachWave.Hard = 3;
		default.Trader_NewWeaponEachWave.Suicidal = 3;
		default.Trader_NewWeaponEachWave.HOE = 3;
		default.Trader_NewWeaponEachWave.Custom = 3;
		default.Trader_AmmoPriceMultiplier.Normal = 0.500000f;
		default.Trader_AmmoPriceMultiplier.Hard = 0.500000f;
		default.Trader_AmmoPriceMultiplier.Suicidal = 0.500000f;
		default.Trader_AmmoPriceMultiplier.HOE = 0.500000f;
		default.Trader_AmmoPriceMultiplier.Custom = 0.500000f;
		default.Trader_ArmorPrice.Normal = 2;
		default.Trader_ArmorPrice.Hard = 2;
		default.Trader_ArmorPrice.Suicidal = 2;
		default.Trader_ArmorPrice.HOE = 2;
