...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < class'ZedternalReborn.Config_Base'.const.CurrentVersion)
	{
		...
		default.Objective_Probability.Normal = 0.250000f;
		default.Objective_Probability.Hard = 0.250000f;
		default.Objective_Probability.Suicidal = 0.250000f;
		default.Objective_Probability.HOE = 0.250000f;
		default.Objective_Probability.Custom = 0.250000f;
		default.Objective_BaseDosh.Normal = 180;
		default.Objective_BaseDosh.Hard = 225;
		default.Objective_BaseDosh.Suicidal = 270;
		default.Objective_BaseDosh.HOE = 315;
		default.Objective_BaseDosh.Custom = 315;
		default.Objective_PctOfWaveKilledForMaxReward.Normal = 0.650000f;
		default.Objective_PctOfWaveKilledForMaxReward.Hard = 0.700000f;
		default.Objective_PctOfWaveKilledForMaxReward.Suicidal = 0.750000f;
		default.Objective_PctOfWaveKilledForMaxReward.HOE = 0.800000f;
		default.Objective_PctOfWaveKilledForMaxReward.Custom = 0.800000f;
		default.Objective_DoshIncreaseModifierPerWave.Normal = 0.150000f;
		default.Objective_DoshIncreaseModifierPerWave.Hard = 0.100000f;
		default.Objective_DoshIncreaseModifierPerWave.Suicidal = 0.100000f;
		default.Objective_DoshIncreaseModifierPerWave.HOE = 0.050000f;
		default.Objective_DoshIncreaseModifierPerWave.Custom = 0.050000f;
