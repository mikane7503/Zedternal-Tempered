...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < class'ZedternalReborn.Config_Base'.const.CurrentVersion)
	{
		...
		default.Pickup_AmmoPickupBasePercentage.Normal = 0.400000f;
		default.Pickup_AmmoPickupBasePercentage.Hard = 0.350000f;
		default.Pickup_AmmoPickupBasePercentage.Suicidal = 0.300000f;
		default.Pickup_AmmoPickupBasePercentage.HOE = 0.750000f;
		default.Pickup_AmmoPickupBasePercentage.Custom = 0.750000f;
		default.Pickup_AmmoPickupPercentageIncPerWave.Normal = 0.040000f;
		default.Pickup_AmmoPickupPercentageIncPerWave.Hard = 0.030000f;
		default.Pickup_AmmoPickupPercentageIncPerWave.Suicidal = 0.020000f;
		default.Pickup_AmmoPickupPercentageIncPerWave.HOE = 0.0f;
		default.Pickup_AmmoPickupPercentageIncPerWave.Custom = 0.0f;
		default.Pickup_AmmoPickupMaxPercentage.Normal = 0.950000f;
		default.Pickup_AmmoPickupMaxPercentage.Hard = 0.900000f;
		default.Pickup_AmmoPickupMaxPercentage.Suicidal = 0.850000f;
		default.Pickup_AmmoPickupMaxPercentage.HOE = 0.750000f;
		default.Pickup_AmmoPickupMaxPercentage.Custom = 0.750000f;
		default.Pickup_ItemPickupBasePercentage.Normal = 0.450000f;
		default.Pickup_ItemPickupBasePercentage.Hard = 0.350000f;
		default.Pickup_ItemPickupBasePercentage.Suicidal = 0.250000f;
		default.Pickup_ItemPickupBasePercentage.HOE = 0.100000f;
		default.Pickup_ItemPickupBasePercentage.Custom = 0.100000f;
		default.Pickup_ItemPickupPercentageIncPerWave.Normal = 0.030000f;
		default.Pickup_ItemPickupPercentageIncPerWave.Hard = 0.025000f;
		default.Pickup_ItemPickupPercentageIncPerWave.Suicidal = 0.020000f;
		default.Pickup_ItemPickupPercentageIncPerWave.HOE = 0.015000f;
		default.Pickup_ItemPickupPercentageIncPerWave.Custom = 0.015000f;
		default.Pickup_ItemPickupMaxPercentage.Normal = 0.900000f;
		default.Pickup_ItemPickupMaxPercentage.Hard = 0.800000f;
		default.Pickup_ItemPickupMaxPercentage.Suicidal = 0.700000f;
		default.Pickup_ItemPickupMaxPercentage.HOE = 0.550000f;
		default.Pickup_ItemPickupMaxPercentage.Custom = 0.550000f;
