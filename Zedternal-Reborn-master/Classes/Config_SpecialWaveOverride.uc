...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < class'ZedternalReborn.Config_Base'.const.CurrentVersion)
	{
		...
		default.SpecialWaveOverride_SpecialWaves.Length = 4;
		default.SpecialWaveOverride_SpecialWaves[0].Wave = 4;
		default.SpecialWaveOverride_SpecialWaves[0].FirstPath = "ZedternalReborn.WMSpecialWave_HellFire";
		default.SpecialWaveOverride_SpecialWaves[0].SecondPath = "";
		default.SpecialWaveOverride_SpecialWaves[0].Probability = 0.250000f;
		default.SpecialWaveOverride_SpecialWaves[1].Wave = 8;
		default.SpecialWaveOverride_SpecialWaves[1].FirstPath = "ZedternalReborn.WMSpecialWave_UnlimitedAmmo";
		default.SpecialWaveOverride_SpecialWaves[1].SecondPath = "";
		default.SpecialWaveOverride_SpecialWaves[1].Probability = 0.500000f;
		default.SpecialWaveOverride_SpecialWaves[2].Wave = 12;
		default.SpecialWaveOverride_SpecialWaves[2].FirstPath = "ZedternalReborn.WMSpecialWave_BloodyChainsaw";
		default.SpecialWaveOverride_SpecialWaves[2].SecondPath = "";
		default.SpecialWaveOverride_SpecialWaves[2].Probability = 0.250000f;
		default.SpecialWaveOverride_SpecialWaves[3].Wave = 16;
		default.SpecialWaveOverride_SpecialWaves[3].FirstPath = "ZedternalReborn.WMSpecialWave_Dosh";
		default.SpecialWaveOverride_SpecialWaves[3].SecondPath = "";
		default.SpecialWaveOverride_SpecialWaves[3].Probability = 0.500000f;
