...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < class'ZedternalReborn.Config_Base'.const.CurrentVersion)
	{
		...
		default.ZedLarge_HealthModifier.Normal = 1.100000f;
		default.ZedLarge_HealthModifier.Hard = 1.150000f;
		default.ZedLarge_HealthModifier.Suicidal = 1.200000f;
		default.ZedLarge_HealthModifier.HOE = 1.200000f;
		default.ZedLarge_HealthModifier.Custom = 1.200000f;
		default.ZedLarge_ExtraHealthModifierPerPlayer.Normal = 0.080000f;
		default.ZedLarge_ExtraHealthModifierPerPlayer.Hard = 0.080000f;
		default.ZedLarge_ExtraHealthModifierPerPlayer.Suicidal = 0.090000f;
		default.ZedLarge_ExtraHealthModifierPerPlayer.HOE = 0.100000f;
		default.ZedLarge_ExtraHealthModifierPerPlayer.Custom = 0.100000f;
		default.ZedLarge_HeadHealthModifier.Normal = 1.000000f;
		default.ZedLarge_HeadHealthModifier.Hard = 1.000000f;
		default.ZedLarge_HeadHealthModifier.Suicidal = 1.000000f;
		default.ZedLarge_HeadHealthModifier.HOE = 1.000000f;
		default.ZedLarge_HeadHealthModifier.Custom = 1.000000f;
		default.ZedLarge_DamageModifier.Normal = 0.700000f;
		default.ZedLarge_DamageModifier.Hard = 0.750000f;
		default.ZedLarge_DamageModifier.Suicidal = 0.850000f;
		default.ZedLarge_DamageModifier.HOE = 0.950000f;
		default.ZedLarge_DamageModifier.Custom = 0.950000f;
		default.ZedLarge_SoloDamageModifier.Normal = 0.550000f;
		default.ZedLarge_SoloDamageModifier.Hard = 0.650000f;
		default.ZedLarge_SoloDamageModifier.Suicidal = 0.750000f;
		default.ZedLarge_SoloDamageModifier.HOE = 0.850000f;
		default.ZedLarge_SoloDamageModifier.Custom = 0.850000f;
		default.ZedLarge_SpeedModifier.Normal = 0.720000f;
		default.ZedLarge_SpeedModifier.Hard = 0.750000f;
		default.ZedLarge_SpeedModifier.Suicidal = 0.800000f;
		default.ZedLarge_SpeedModifier.HOE = 0.840000f;
		default.ZedLarge_SpeedModifier.Custom = 0.840000f;
