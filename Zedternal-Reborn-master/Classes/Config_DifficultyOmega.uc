...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < class'ZedternalReborn.Config_Base'.const.CurrentVersion)
	{
		...
		default.ZedOmega_HealthModifier.Normal = 1.100000f;
		default.ZedOmega_HealthModifier.Hard = 1.150000f;
		default.ZedOmega_HealthModifier.Suicidal = 1.200000f;
		default.ZedOmega_HealthModifier.HOE = 1.200000f;
		default.ZedOmega_HealthModifier.Custom = 1.200000f;
		default.ZedOmega_ExtraHealthModifierPerPlayer.Normal = 0.020000f;
		default.ZedOmega_ExtraHealthModifierPerPlayer.Hard = 0.020000f;
		default.ZedOmega_ExtraHealthModifierPerPlayer.Suicidal = 0.030000f;
		default.ZedOmega_ExtraHealthModifierPerPlayer.HOE = 0.030000f;
		default.ZedOmega_ExtraHealthModifierPerPlayer.Custom = 0.030000f;
		default.ZedOmega_HeadHealthModifier.Normal = 1.000000f;
		default.ZedOmega_HeadHealthModifier.Hard = 1.000000f;
		default.ZedOmega_HeadHealthModifier.Suicidal = 1.000000f;
		default.ZedOmega_HeadHealthModifier.HOE = 1.000000f;
		default.ZedOmega_HeadHealthModifier.Custom = 1.000000f;
		default.ZedOmega_DamageModifier.Normal = 0.700000f;
		default.ZedOmega_DamageModifier.Hard = 0.750000f;
		default.ZedOmega_DamageModifier.Suicidal = 0.850000f;
		default.ZedOmega_DamageModifier.HOE = 0.950000f;
		default.ZedOmega_DamageModifier.Custom = 0.950000f;
		default.ZedOmega_SoloDamageModifier.Normal = 0.450000f;
		default.ZedOmega_SoloDamageModifier.Hard = 0.550000f;
		default.ZedOmega_SoloDamageModifier.Suicidal = 0.630000f;
		default.ZedOmega_SoloDamageModifier.HOE = 0.700000f;
		default.ZedOmega_SoloDamageModifier.Custom = 0.700000f;
		default.ZedOmega_SpeedModifier.Normal = 0.710000f;
		default.ZedOmega_SpeedModifier.Hard = 0.710000f;
		default.ZedOmega_SpeedModifier.Suicidal = 0.735000f;
		default.ZedOmega_SpeedModifier.HOE = 0.760000f;
		default.ZedOmega_SpeedModifier.Custom = 0.760000f;
