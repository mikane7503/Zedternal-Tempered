...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < class'ZedternalReborn.Config_Base'.const.CurrentVersion)
	{
		...
		default.Wave_MaxUniqueZedsInWave.Normal = 999;
		default.Wave_MaxUniqueZedsInWave.Hard = 999;
		default.Wave_MaxUniqueZedsInWave.Suicidal = 999;
		default.Wave_MaxUniqueZedsInWave.HOE = 999;
		default.Wave_MaxUniqueZedsInWave.Custom = 999;
		default.Wave_MaxSpawnedZedsOnLevel.Normal = 48;
		default.Wave_MaxSpawnedZedsOnLevel.Hard = 48;
		default.Wave_MaxSpawnedZedsOnLevel.Suicidal = 48;
		default.Wave_MaxSpawnedZedsOnLevel.HOE = 48;
		default.Wave_MaxSpawnedZedsOnLevel.Custom = 48;
		default.Wave_MaxNumberOfZedsToSpawn.Normal = 999;
		default.Wave_MaxNumberOfZedsToSpawn.Hard = 999;
		default.Wave_MaxNumberOfZedsToSpawn.Suicidal = 999;
		default.Wave_MaxNumberOfZedsToSpawn.HOE = 999;
		default.Wave_MaxNumberOfZedsToSpawn.Custom = 999;
