...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < class'ZedternalReborn.Config_Base'.const.CurrentVersion)
	{
		...
		default.ZedNormal_HealthModifier.Normal = 1.100000f;
		default.ZedNormal_HealthModifier.Hard = 1.150000f;
		default.ZedNormal_HealthModifier.Suicidal = 1.200000f;
		default.ZedNormal_HealthModifier.HOE = 1.200000f;
		default.ZedNormal_HealthModifier.Custom = 1.200000f;
		default.ZedNormal_ExtraHealthModifierPerPlayer.Normal = 0.060000f;
		default.ZedNormal_ExtraHealthModifierPerPlayer.Hard = 0.060000f;
		default.ZedNormal_ExtraHealthModifierPerPlayer.Suicidal = 0.070000f;
		default.ZedNormal_ExtraHealthModifierPerPlayer.HOE = 0.080000f;
		default.ZedNormal_ExtraHealthModifierPerPlayer.Custom = 0.080000f;
		default.ZedNormal_HeadHealthModifier.Normal = 1.000000f;
		default.ZedNormal_HeadHealthModifier.Hard = 1.000000f;
		default.ZedNormal_HeadHealthModifier.Suicidal = 1.000000f;
		default.ZedNormal_HeadHealthModifier.HOE = 1.000000f;
		default.ZedNormal_HeadHealthModifier.Custom = 1.000000f;
		default.ZedNormal_DamageModifier.Normal = 0.700000f;
		default.ZedNormal_DamageModifier.Hard = 0.750000f;
		default.ZedNormal_DamageModifier.Suicidal = 0.850000f;
		default.ZedNormal_DamageModifier.HOE = 0.950000f;
		default.ZedNormal_DamageModifier.Custom = 0.950000f;
		default.ZedNormal_SoloDamageModifier.Normal = 0.600000f;
		default.ZedNormal_SoloDamageModifier.Hard = 0.650000f;
		default.ZedNormal_SoloDamageModifier.Suicidal = 0.750000f;
		default.ZedNormal_SoloDamageModifier.HOE = 0.850000f;
		default.ZedNormal_SoloDamageModifier.Custom = 0.850000f;
		default.ZedNormal_SpeedModifier.Normal = 0.800000f;
		default.ZedNormal_SpeedModifier.Hard = 0.820000f;
		default.ZedNormal_SpeedModifier.Suicidal = 0.840000f;
		default.ZedNormal_SpeedModifier.HOE = 0.860000f;
		default.ZedNormal_SpeedModifier.Custom = 0.860000f;
