...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < class'ZedternalReborn.Config_Base'.const.CurrentVersion)
	{
		...
		default.Map_Settings.Length = 3;
		default.Map_Settings[0].MapName = "KF-Random_Holdout";
		default.Map_Settings[0].Difficulty.Length = 5;
		default.Map_Settings[0].Difficulty[0] = 0;
		default.Map_Settings[0].Difficulty[1] = 1;
		default.Map_Settings[0].Difficulty[2] = 2;
		default.Map_Settings[0].Difficulty[3] = 3;
		default.Map_Settings[0].Difficulty[4] = 4;
		default.Map_Settings[0].StartingDosh = 4000;
		default.Map_Settings[0].StartingWave = 1;
		default.Map_Settings[0].FinalWave = 30;
		default.Map_Settings[0].StartingTraderTime = 0;
		default.Map_Settings[0].ZedNumberScale = 1.000000f;
		default.Map_Settings[0].ZedSpawnRate = 8.000000f;
		...
		default.Map_Settings[0].EnableAmmoPickups = True;
		default.Map_Settings[0].EnableWeaponPickups = True;
		default.Map_Settings[0].ArmorSpawnOnMap = True;
		default.Map_Settings[0].OverrideKismetPickups = True;
		default.Map_Settings[0].AmmoPickupBase = 0.400000f;
		default.Map_Settings[0].AmmoPickupIncPerWave = 0.040000f;
		default.Map_Settings[0].AmmoPickupMax = 0.950000f;
		default.Map_Settings[0].ItemPickupBase = 0.450000f;
		default.Map_Settings[0].ItemPickupIncPerWave = 0.030000f;
		default.Map_Settings[0].ItemPickupMax = 0.900000f;
		default.Map_Settings[1].MapName = "KF-Simple_Holdout";
		default.Map_Settings[1].Difficulty.Length = 5;
		default.Map_Settings[1].Difficulty[0] = 0;
		default.Map_Settings[1].Difficulty[1] = 1;
		default.Map_Settings[1].Difficulty[2] = 2;
		default.Map_Settings[1].Difficulty[3] = 3;
		default.Map_Settings[1].Difficulty[4] = 4;
		default.Map_Settings[1].StartingDosh = 3000;
		default.Map_Settings[1].StartingWave = 1;
		default.Map_Settings[1].FinalWave = 30;
		default.Map_Settings[1].StartingTraderTime = 0;
		default.Map_Settings[1].ZedNumberScale = 1.000000f;
		default.Map_Settings[1].ZedSpawnRate = 8.000000f;
		default.Map_Settings[1].ZedStuckThreshold = 4;
		default.Map_Settings[1].ZedStuckTimeout = 150;
		default.Map_Settings[1].AllTraders = False;
		default.Map_Settings[1].EnableAmmoPickups = True;
		default.Map_Settings[1].EnableWeaponPickups = True;
		default.Map_Settings[1].ArmorSpawnOnMap = True;
		default.Map_Settings[1].OverrideKismetPickups = True;
		default.Map_Settings[1].AmmoPickupBase = 0.400000f;
		default.Map_Settings[1].AmmoPickupIncPerWave = 0.040000f;
		default.Map_Settings[1].AmmoPickupMax = 0.950000f;
		default.Map_Settings[1].ItemPickupBase = 0.450000f;
		default.Map_Settings[1].ItemPickupIncPerWave = 0.030000f;
		default.Map_Settings[1].ItemPickupMax = 0.900000f;
		default.Map_Settings[2].MapName = "KF-Zedternal_Holdout";
		default.Map_Settings[2].Difficulty.Length = 5;
		default.Map_Settings[2].Difficulty[0] = 0;
		default.Map_Settings[2].Difficulty[1] = 1;
		default.Map_Settings[2].Difficulty[2] = 2;
		default.Map_Settings[2].Difficulty[3] = 3;
		default.Map_Settings[2].Difficulty[4] = 4;
		default.Map_Settings[2].StartingDosh = 2000;
		default.Map_Settings[2].StartingWave = 1;
		default.Map_Settings[2].FinalWave = 30;
		default.Map_Settings[2].StartingTraderTime = 0;
		default.Map_Settings[2].ZedNumberScale = 1.000000f;
		default.Map_Settings[2].ZedSpawnRate = 8.000000f;
		default.Map_Settings[2].ZedStuckThreshold = 4;
		default.Map_Settings[2].ZedStuckTimeout = 150;
		default.Map_Settings[2].AllTraders = False;
		default.Map_Settings[2].EnableAmmoPickups = True;
		default.Map_Settings[2].EnableWeaponPickups = True;
		default.Map_Settings[2].ArmorSpawnOnMap = True;
		default.Map_Settings[2].OverrideKismetPickups = True;
		default.Map_Settings[2].AmmoPickupBase = 0.400000f;
		default.Map_Settings[2].AmmoPickupIncPerWave = 0.040000f;
		default.Map_Settings[2].AmmoPickupMax = 0.950000f;
		default.Map_Settings[2].ItemPickupBase = 0.450000f;
		default.Map_Settings[2].ItemPickupIncPerWave = 0.030000f;
		default.Map_Settings[2].ItemPickupMax = 0.900000f;
