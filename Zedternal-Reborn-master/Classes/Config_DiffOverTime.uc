...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < class'ZedternalReborn.Config_Base'.const.CurrentVersion)
	{
		...
		default.DiffOverTime_NormalZedHealthIncPerWave.Normal = 0.040000f;
		default.DiffOverTime_NormalZedHealthIncPerWave.Hard = 0.040000f;
		default.DiffOverTime_NormalZedHealthIncPerWave.Suicidal = 0.080000f;
		default.DiffOverTime_NormalZedHealthIncPerWave.HOE = 0.080000f;
		default.DiffOverTime_NormalZedHealthIncPerWave.Custom = 0.080000f;
		default.DiffOverTime_NormalZedHealthPowerPerWave.Normal = 0.150000f;
		default.DiffOverTime_NormalZedHealthPowerPerWave.Hard = 0.150000f;
		default.DiffOverTime_NormalZedHealthPowerPerWave.Suicidal = 0.030000f;
		default.DiffOverTime_NormalZedHealthPowerPerWave.HOE = 0.030000f;
		default.DiffOverTime_NormalZedHealthPowerPerWave.Custom = 0.030000f;
		default.DiffOverTime_LargeZedHealthIncPerWave.Normal = 0.040000f;
		default.DiffOverTime_LargeZedHealthIncPerWave.Hard = 0.040000f;
		default.DiffOverTime_LargeZedHealthIncPerWave.Suicidal = 0.080000f;
		default.DiffOverTime_LargeZedHealthIncPerWave.HOE = 0.080000f;
		default.DiffOverTime_LargeZedHealthIncPerWave.Custom = 0.080000f;
		default.DiffOverTime_LargeZedHealthPowerPerWave.Normal = 0.180000f;
		default.DiffOverTime_LargeZedHealthPowerPerWave.Hard = 0.180000f;
		default.DiffOverTime_LargeZedHealthPowerPerWave.Suicidal = 0.030000f;
		default.DiffOverTime_LargeZedHealthPowerPerWave.HOE = 0.030000f;
		default.DiffOverTime_LargeZedHealthPowerPerWave.Custom = 0.030000f;
		default.DiffOverTime_OmegaZedHealthIncPerWave.Normal = 0.040000f;
		default.DiffOverTime_OmegaZedHealthIncPerWave.Hard = 0.040000f;
		default.DiffOverTime_OmegaZedHealthIncPerWave.Suicidal = 0.060000f;
		default.DiffOverTime_OmegaZedHealthIncPerWave.HOE = 0.060000f;
		default.DiffOverTime_OmegaZedHealthIncPerWave.Custom = 0.060000f;
		default.DiffOverTime_OmegaZedHealthPowerPerWave.Normal = 0.180000f;
		default.DiffOverTime_OmegaZedHealthPowerPerWave.Hard = 0.180000f;
		default.DiffOverTime_OmegaZedHealthPowerPerWave.Suicidal = 0.020000f;
		default.DiffOverTime_OmegaZedHealthPowerPerWave.HOE = 0.020000f;
		default.DiffOverTime_OmegaZedHealthPowerPerWave.Custom = 0.020000f;
		default.DiffOverTime_ZedDamageIncPerWave.Normal = 0.025000f;
		default.DiffOverTime_ZedDamageIncPerWave.Hard = 0.025000f;
		default.DiffOverTime_ZedDamageIncPerWave.Suicidal = 0.080000f;
		default.DiffOverTime_ZedDamageIncPerWave.HOE = 0.080000f;
		default.DiffOverTime_ZedDamageIncPerWave.Custom = 0.080000f;
		default.DiffOverTime_ZedDamagePowerPerWave.Normal = 0.007000f;
		default.DiffOverTime_ZedDamagePowerPerWave.Hard = 0.007000f;
		default.DiffOverTime_ZedDamagePowerPerWave.Suicidal = 0.010000f;
		default.DiffOverTime_ZedDamagePowerPerWave.HOE = 0.010000f;
		default.DiffOverTime_ZedDamagePowerPerWave.Custom = 0.010000f;
		default.DiffOverTime_ZedSpeedIncPerWave.Normal = 0.012000f;
		default.DiffOverTime_ZedSpeedIncPerWave.Hard = 0.012000f;
		default.DiffOverTime_ZedSpeedIncPerWave.Suicidal = 0.008000f;
		default.DiffOverTime_ZedSpeedIncPerWave.HOE = 0.008000f;
		default.DiffOverTime_ZedSpeedIncPerWave.Custom = 0.008000f;
		default.DiffOverTime_ZedSpeedPowerPerWave.Normal = 0.002000f;
		default.DiffOverTime_ZedSpeedPowerPerWave.Hard = 0.002000f;
		default.DiffOverTime_ZedSpeedPowerPerWave.Suicidal = 0.002000f;
		default.DiffOverTime_ZedSpeedPowerPerWave.HOE = 0.002000f;
		default.DiffOverTime_ZedSpeedPowerPerWave.Custom = 0.002000f;
		default.DiffOverTime_ZedSprintChanceIncPerWave.Normal = 0.005000f;
		default.DiffOverTime_ZedSprintChanceIncPerWave.Hard = 0.005000f;
		default.DiffOverTime_ZedSprintChanceIncPerWave.Suicidal = 0.005000f;
		default.DiffOverTime_ZedSprintChanceIncPerWave.HOE = 0.005000f;
		default.DiffOverTime_ZedSprintChanceIncPerWave.Custom = 0.005000f;
		default.DiffOverTime_ZedHardAttackChanceIncPerWave.Normal = 0.010000f;
		default.DiffOverTime_ZedHardAttackChanceIncPerWave.Hard = 0.010000f;
		default.DiffOverTime_ZedHardAttackChanceIncPerWave.Suicidal = 0.010000f;
		default.DiffOverTime_ZedHardAttackChanceIncPerWave.HOE = 0.010000f;
		default.DiffOverTime_ZedHardAttackChanceIncPerWave.Custom = 0.010000f;
		default.DiffOverTime_ZedDoshPenaltyPerWave.Normal = 0.015000f;
		default.DiffOverTime_ZedDoshPenaltyPerWave.Hard = 0.015000f;
		default.DiffOverTime_ZedDoshPenaltyPerWave.Suicidal = 0.015000f;
		default.DiffOverTime_ZedDoshPenaltyPerWave.HOE = 0.025000f;
		default.DiffOverTime_ZedDoshPenaltyPerWave.Custom = 0.025000f;
		default.DiffOverTime_ZedDoshPenaltyLimit.Normal = 0.600000f;
		default.DiffOverTime_ZedDoshPenaltyLimit.Hard = 0.600000f;
		default.DiffOverTime_ZedDoshPenaltyLimit.Suicidal = 0.600000f;
		default.DiffOverTime_ZedDoshPenaltyLimit.HOE = 0.800000f;
		default.DiffOverTime_ZedDoshPenaltyLimit.Custom = 0.800000f;
