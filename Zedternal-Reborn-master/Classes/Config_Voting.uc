...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < class'ZedternalReborn.Config_Base'.const.CurrentVersion)
	{
		...
		default.Voting_SkipTraderVotingPercentage.Normal = 0.750000f;
		default.Voting_SkipTraderVotingPercentage.Hard = 0.750000f;
		default.Voting_SkipTraderVotingPercentage.Suicidal = 0.750000f;
		default.Voting_SkipTraderVotingPercentage.HOE = 0.500000f;
		default.Voting_SkipTraderVotingPercentage.Custom = 0.500000f;
		default.Voting_PauseGameVotingPercentage.Normal = 0.750000f;
		default.Voting_PauseGameVotingPercentage.Hard = 0.750000f;
		default.Voting_PauseGameVotingPercentage.Suicidal = 0.750000f;
		default.Voting_PauseGameVotingPercentage.HOE = 0.500000f;
		default.Voting_PauseGameVotingPercentage.Custom = 0.500000f;
