class ZTUpgrade_Skill_HighRiskInvestment_Helper extends Info transient;
...
function CheckForLargePurchases()
{
    ...
    if (DoshSpent > 0)
    {
        ...
        MinAmount = class'ZTUpgrade_Skill_HighRiskInvestment'.default.MinPurchaseAmount[UpgradeLevel - 1];
            ...
            if (FRand() <= InvestmentChance)
            {
                ...
                if (KFPC != None)
                {
                    ...
                    if (KFPRI != None)
                    {
                        ...
                        class'ZTMessageManager'.static.SendCritical(KFPC, "HIGH RISK INVESTMENT PAID OFF! +" $ DoshSpent $ " Dosh return!");
                    }
                }
            }
        }
...
defaultproperties
{
    ...
    Name="Default__ZTUpgrade_Skill_HighRiskInvestment_Helper"
}