...
class ZTWrapper_Skill_Parry extends WMUpgrade_Skill_Parry config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_Resistance[0] = 0.080000f;
		default.Cfg_Resistance[1] = 0.160000f;
		default.Cfg_Damage.Length = 2;
		default.Cfg_Damage[0] = 0.300000f;
		default.Cfg_Damage[1] = 0.750000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_Parry"
}
