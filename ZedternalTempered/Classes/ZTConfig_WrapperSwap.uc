...
//
// Call SwapAll() from ZTGameInfo_Endless.InitGame() BEFORE super.
//
// Naming convention:
//   Original: ZedternalReborn.WMUpgrade_Perk_Berserker
//   Wrapper:  ZedternalTempered.ZTWrapper_Perk_Berserker
//
...
// ===================================================================
class ZTConfig_WrapperSwap extends Object;
...
static function SwapPerkPaths()
{
	...
	for (i = 0; i < class'ZedternalReborn.Config_PerkUpgrade'.default.PerkUpgrade_Upgrade.Length; i++)
	{
		...
		WrapperPath = "ZedternalTempered.DKWrapper_Perk_" $ ShortName;

		if (DynamicLoadObject(WrapperPath, class'Class', True) == None)
			WrapperPath = "ZedternalTempered.DKWrapper_Perk_Psy_" $ ShortName;
...
static function SwapSkillPaths()
{
	...
	for (i = 0; i < class'ZedternalReborn.Config_SkillUpgrade'.default.SkillUpgrade_Upgrade.Length; i++)
	{
		...
		WrapperPath = "ZedternalTempered.DKWrapper_Skill_" $ ShortName;

		if (DynamicLoadObject(WrapperPath, class'Class', True) == None)
			WrapperPath = "ZedternalTempered.DKWrapper_Skill_Psy_" $ ShortName;
...
static function SwapEquipmentPaths()
{
	...
	for (i = 0; i < class'ZedternalReborn.Config_EquipmentUpgrade'.default.EquipmentUpgrade_Upgrade.Length; i++)
	{
		...
		WrapperPath = "ZedternalTempered.DKWrapper_Equipment_" $ ShortName;

		if (DynamicLoadObject(WrapperPath, class'Class', True) == None)
			WrapperPath = "ZedternalTempered.DKWrapper_Equipment_Psy_" $ ShortName;
...
// ZTUI_UPGMenu.BuildWeaponUpgradeList gates visibility by skill ownership:
...
static function InjectHollowWeaponUpgrades()
{
	...
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_Execute");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_Execute_Deluxe");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_Headhunter");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_Headhunter_Deluxe");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_VoidInfusion");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_VoidInfusion_Deluxe");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_VoidSustain");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_VoidSustain_Deluxe");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_VoidReserves");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_VoidReserves_Deluxe");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_TitanSlayer");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_TitanSlayer_Deluxe");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_VoidSight");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_VoidSight_Deluxe");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_ZedTimeFocus");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_ZedTimeFocus_Deluxe");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_ReapersEdge");
	UpgradePaths.AddItem("ZedternalTempered.ZTWeaponUpg_ReapersEdge_Deluxe");
...
defaultproperties
{
	Name="Default__ZTConfig_WrapperSwap"
}
