...
class ZTWrapper_Skill_QuickDraw extends WMUpgrade_Skill_QuickDraw config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_SwitchSpeed.Length = 2;
		default.Cfg_SwitchSpeed[0] = 1.000000f;
		default.Cfg_SwitchSpeed[1] = 2.500000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_QuickDraw"
}
