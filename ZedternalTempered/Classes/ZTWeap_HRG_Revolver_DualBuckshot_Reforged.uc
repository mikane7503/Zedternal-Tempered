class ZTWeap_HRG_Revolver_DualBuckshot_Reforged extends KFWeap_HRG_Revolver_DualBuckshot;
...
defaultproperties
{
	...
	SingleClass=class'ZedternalTempered.ZTWeap_HRG_Revolver_Buckshot_Reforged'
}
