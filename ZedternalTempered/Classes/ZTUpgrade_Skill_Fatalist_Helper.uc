// ===================================================================
// ZTUpgrade_Skill_Fatalist_Helper
//
...
// ===================================================================
class ZTUpgrade_Skill_Fatalist_Helper extends ZTUpgrade_Skill_OmenBase_Helper transient;
...
function float GetRewardMultiplier()
{
    ...
    foreach Owner.ChildActors(class'ZTUpgrade_Perk_Omen_Helper', OH)
    {
...
defaultproperties
{
    ...
    Name="Default__ZTUpgrade_Skill_Fatalist_Helper"
}
