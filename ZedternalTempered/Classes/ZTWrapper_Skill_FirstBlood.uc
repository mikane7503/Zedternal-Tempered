...
class ZTWrapper_Skill_FirstBlood extends WMUpgrade_Skill_FirstBlood config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_DamageDelta.Length = 2;
		default.Cfg_DamageDelta[0] = 0.050000f;
		default.Cfg_DamageDelta[1] = 0.100000f;
		default.Cfg_DamageMax.Length = 2;
		default.Cfg_DamageMax[0] = 2.000000f;
		default.Cfg_DamageMax[1] = 5.000000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_FirstBlood"
}
