...
class ZTWrapper_Skill_BattleSurgeon extends WMUpgrade_Skill_BattleSurgeon config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_OtherDamage[0] = 0.100000f;
		default.Cfg_OtherDamage[1] = 0.250000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_BattleSurgeon"
}
