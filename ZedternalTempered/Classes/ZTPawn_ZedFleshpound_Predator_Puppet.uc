// ===================================================================
// ZTPawn_ZedFleshpound_Predator_Puppet
//
// Puppet Master controllable variant of ZR's WMPawn_ZedFleshpound_Predator (Case A).
// Fleshpound skeleton -> reuses KFSM_PlayerFleshpound_*. Control layer only.
// Stats/mesh/identity stay inherited.
// ===================================================================
class ZTPawn_ZedFleshpound_Predator_Puppet extends WMPawn_ZedFleshpound_Predator;
