class ZTConfig_EventWave extends Object config(ZedternalUnlimited);
...
// Loaded from [ZTConfig_EventWave] section of active locale .int / .kor.
...
static function UpdateConfig()
{
	...
	if (default.MODEVERSION < 5)
	{
		...
		default.EventWaveProbability = 0.250000f;
		default.MinWave = 2;
		default.MaxPerMatch = 0;
		default.Weight_ChainGang = 0.200000f;
		default.Weight_MarkedForDeath = 0.200000f;
		default.Weight_Highlander = 0.000000f;
		default.Weight_Amogus = 0.300000f;
		default.Weight_Paranoia = 0.000000f;
		default.Weight_Redacted = 0.050000f;
		default.Weight_HotPotato = 0.200000f;
		default.Weight_BlackoutPulse = 0.000000f;
		default.Weight_DeadSilence = 0.100000f;
		default.Weight_Isolation = 0.100000f;
		default.Weight_OneInTheChamber = 0.000000f;
		default.Weight_RAGE = 0.010000f;
		default.Weight_VIP = 0.200000f;
		default.Weight_Nemesis = 0.100000f;
		default.Weight_XMen = 0.100000f;
		default.Weight_FogOfWar = 0.100000f;
		default.Weight_Duel = 0.000000f;
		default.Weight_Jitterbug = 0.200000f;
		default.Weight_CostumeParty = 0.200000f;
		default.Weight_DontBlink = 0.000000f;
...
// English when the .int [ZTConfig_EventWave] section lacks an entry (e.g. newly
...
// Returns true if this event requires the ZTEventWaveManager
...
defaultproperties
{
	Name="Default__ZTConfig_EventWave"
}
