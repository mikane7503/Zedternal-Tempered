...
class ZTUpgrade_Skill_TrophyCase extends ZTUpgrade_Skill
...
static function ZTUpgrade_Skill_TrophyCase_Helper GetHelper(Pawn OwnerPawn)
{
	local ZTUpgrade_Skill_TrophyCase_Helper H;

	if (KFPawn_Human(OwnerPawn) == None)
		return None;

	foreach OwnerPawn.ChildActors(class'ZTUpgrade_Skill_TrophyCase_Helper', H)
		return H;

	return OwnerPawn.Spawn(class'ZTUpgrade_Skill_TrophyCase_Helper', OwnerPawn);
}
...
defaultproperties
{
	...
	LocSection="ZTUpgrade_Skill_TrophyCase"
	...
	Name="Default__ZTUpgrade_Skill_TrophyCase"
}
