...
class ZTWrapper_Skill_BoneBreaker extends WMUpgrade_Skill_BoneBreaker config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_Stumble.Length = 2;
		default.Cfg_Stumble[0] = 0.150000f;
		default.Cfg_Stumble[1] = 0.375000f;
		default.Cfg_Knockdown.Length = 4;
		default.Cfg_Knockdown[0] = 0.100000f;
		default.Cfg_Knockdown[1] = 0.150000f;
		default.Cfg_Knockdown[2] = 0.250000f;
		default.Cfg_Knockdown[3] = 0.300000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_BoneBreaker"
}
