// ===================================================================
// ZTConfig_BossWave - Boss Wave Configuration System
// Manages which boss waves can appear and when
// ===================================================================
class ZTConfig_BossWave extends Object config(DKBossWaves);
...
static function InitializeConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		// ForcedBossWaves=(Wave=1,BossWavePath="ZedternalTempered.ZTSpecialWave_Patriarchs",Probability=1.0)
...
defaultproperties
{
	Name="Default__ZTConfig_BossWave"
}