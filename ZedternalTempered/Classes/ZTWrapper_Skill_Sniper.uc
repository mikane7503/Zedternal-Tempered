// Wrapper for ZedternalReborn.WMUpgrade_Skill_Sniper
class ZTWrapper_Skill_Sniper extends WMUpgrade_Skill_Sniper config(ZedternalUnlimited);
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_Sniper"
}
