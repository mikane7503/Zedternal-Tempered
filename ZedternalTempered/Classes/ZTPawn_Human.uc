// ===================================================================
// ZTPawn_Human - Extends WMPawn_Human
// Adds configurable speed modifier and speed cap support.
// Values are replicated so client prediction stays in sync.
// ===================================================================
class ZTPawn_Human extends WMPawn_Human;

// Replicated speed config values (server reads from ZTConfig_PlayerSpeed)
...
simulated function PostBeginPlay()
{
	...
	{
		DKSpeedModifier = class'ZTConfig_PlayerSpeed'.default.Player_SpeedModifier;
		DKSpeedCap = class'ZTConfig_PlayerSpeed'.default.Player_SpeedCap;
	}
}
