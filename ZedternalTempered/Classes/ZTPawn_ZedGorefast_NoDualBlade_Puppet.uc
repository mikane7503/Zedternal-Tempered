// ===================================================================
// ZTPawn_ZedGorefast_NoDualBlade_Puppet
//
// Puppet Master controllable variant of ZR's WMPawn_ZedGorefast_NoDualBlade (Case A).
// Gorefast skeleton -> reuses the stock Gorefast player kit
// (KFSM_PlayerGorefast_Melee / _Melee2 / _Melee3 / _Block). Control layer only,
// copied from KFPawn_ZedGorefast_Versus (which is itself pure defaultproperties).
// Stats/mesh/identity stay inherited.
// ===================================================================
class ZTPawn_ZedGorefast_NoDualBlade_Puppet extends WMPawn_ZedGorefast_NoDualBlade;
