...
class ZTWrapper_Skill_HighImpactRound extends WMUpgrade_Skill_HighImpactRound config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_Knockdown[0] = 0.200000f;
		default.Cfg_Knockdown[1] = 0.500000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_HighImpactRound"
}
