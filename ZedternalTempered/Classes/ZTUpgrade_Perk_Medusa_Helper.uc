class ZTUpgrade_Perk_Medusa_Helper extends Info transient;
...
function ShowScaleGainNotification(int ScaleCount)
{
    ...
    if (KFPC != None)
    {
        ...
        MedusaHUD = class'ZTHudWrapper'.static.GetReaperHUD(KFPC);
        if (MedusaHUD != None)
        {
...
defaultproperties
{
    ...
    Name="Default__ZTUpgrade_Perk_Medusa_Helper"
}