...
class ZTWrapper_Skill_Marksman extends WMUpgrade_Skill_Marksman config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_Speed[0] = 0.050000f;
		default.Cfg_Speed[1] = 0.100000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_Marksman"
}
