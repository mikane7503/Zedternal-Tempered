class ZUTUpgrade_Skill_CombatantDoctor extends ZUTUpgrade_Skill_Base;
...
{
	AmmoDivider=30.0f
	HealthThreshold(0)=300
	HealthThreshold(1)=150
	...
	Name="Default__ZUTUpgrade_Skill_CombatantDoctor"
}
