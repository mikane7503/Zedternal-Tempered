// ===================================================================
// ZTConfig_ServerRank - Server-side local rank storage
//
...
// ===================================================================
class ZTConfig_ServerRank extends Object config(ZedternalUnlimited);
...
static function SetPlayerXP(string PlayerID, int XP)
{
	...
	MaxXP = class'ZedternalTempered.ZTRank'.static.GetCumulativeXPForRank(class'ZedternalTempered.ZTRank'.const.MAX_RANK);
...
{
	return class'ZedternalTempered.ZTRank'.static.GetRankFromXP(GetPlayerXP(PlayerID));
}
...
defaultproperties
{
	Name="Default__ZTConfig_ServerRank"
}
