...
class ZTWrapper_Skill_WhirlwindOfLead extends WMUpgrade_Skill_WhirlwindOfLead config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_FireRate[0] = 0.500000f;
		default.Cfg_FireRate[1] = 0.900000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_WhirlwindOfLead"
}
