// ===================================================================
// ZTDomainWheelMovie - GFxMoviePlayer for the Domain ability wheel.
//
...
//
// Input model (driven by ZTPlayerController.DomainPress):
...
//
// Action index order (must match ZTUpgrade_Perk_Domain_Helper.FireAction):
//   0 Shift, 1 Sever/Swap, 2 Discharge, 3 Collapse.
// ===================================================================
class ZTDomainWheelMovie extends GFxMoviePlayer;
