...
//   2. On each player's PostLogin, ZTGameInfo_Endless.PostLogin schedules
...
// ===================================================================
class ZTBulkSync extends Object abstract;
...
// receive-state arrays in ZTPlayerController.
enum EBulkRosterID
{
    BR_AllowedWeapon,         // 0
...
// path in ZTGameReplicationInfo's existing logic, plus any companion
