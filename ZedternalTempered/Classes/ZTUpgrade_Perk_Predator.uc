// ===================================================================
// ZTUpgrade_Perk_Predator - The Hunt Is On
//
...
//
// All dynamic bonuses come from ZTUpgrade_Perk_Predator_Helper
// via accumulated Acc* fields read by these static hooks.
// ===================================================================
class ZTUpgrade_Perk_Predator extends ZTUpgrade_Perk config(ZedternalUnlimited);
...
static simulated function InitiateWeapon(int upgLevel, KFWeapon KFW, KFPawn OwnerPawn)
{
    ...
    if (KFPawn_Human(OwnerPawn) != None && OwnerPawn.Role == Role_Authority)
    {
        ...
        if (H == None)
        {
            H = OwnerPawn.Spawn(class'ZTUpgrade_Perk_Predator_Helper', OwnerPawn);
            if (H != None)
...
static simulated function DeleteHelperClass(Pawn OwnerPawn)
{
    ...
    if (OwnerPawn != None)
    {
        foreach OwnerPawn.ChildActors(class'ZTUpgrade_Perk_Predator_Helper', H)
        {
            H.Destroy();
        }
    }
...
static simulated function ZTUpgrade_Perk_Predator_Helper GetHelper(Pawn OwnerPawn)
{
    local ZTUpgrade_Perk_Predator_Helper H;
    ...
    foreach OwnerPawn.DynamicActors(class'ZTUpgrade_Perk_Predator_Helper', H)
    {
...
defaultproperties
{
	...
	UpgradeIcon(0)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Predator_Rank_0'
    // --- Localization (auto-generated by mass_localize_dk_upgrades.py) ---
    // Strings live in KFGame/Localization/<lang>/ZedternalTempered.<langext>
    // Section: [ZTUpgrade_Perk_Predator]  -- see DKUpgrade_* base class for details.
    bShouldLocalize=True
    LocPackage="ZedternalTempered"
    LocSection="ZTUpgrade_Perk_Predator"
    LocalizeDescriptionLineCount=9

    UpgradeName="Predator"
    UpgradeDescription(0)="<font color=\"#CC8800\">Hunter's Instinct:</font> <font color=\"#FFFFFF\">+0.75%%</font> <font color=\"#FF6666\">All Damage</font> per rank"
    ...
    UpgradeDescription(2)="<font color=\"#87CEEB\">Tier 1 (2-piece):</font> <font color=\"#FFD700\">Swarm Breaker</font> Clot+Crawler <font color=\"#FFFFFF\">+15%% Speed</font>   <font color=\"#FFD700\">Blade Collector</font> Gorefast+Stalker <font color=\"#FFFFFF\">+30%% Melee Damage</font>   <font color=\"#FFD700\">Freak Show</font> Siren+Husk <font color=\"#FFFFFF\">+10%% Resist</font>   <font color=\"#FFD700\">Salvage Run</font> EDAR+Bloat <font color=\"#FFFFFF\">+25%% Reload</font>   <font color=\"#FFD700\">Big Game</font> Scrake+FP <font color=\"#FFFFFF\">+25%% Large Zed Damage</font>"
    ...
    UpgradeDescription(4)="<font color=\"#87CEEB\">Tier 3 (Boss+):</font> <font color=\"#FFD700\">King Slayer</font> Boss+FP <font color=\"#FFFFFF\">+50%% Dmg, +15%% Resist, Grab Immunity</font>   <font color=\"#FFD700\">Apex Predator</font> Boss+Scrake <font color=\"#FFFFFF\">+40%% Dmg, +30%% Speed, See Health</font>   <font color=\"#FFD700\">Trophy Wall</font> Boss+Trash <font color=\"#FFFFFF\">+30%% Dmg, +50%% Ammo, +30%% Reload</font>"
    UpgradeDescription(5)="<font color=\"#87CEEB\">Tier 4:</font> <font color=\"#FFD700\">Legendary Hunter</font> Boss+Boss <font color=\"#FFFFFF\">+75%% Dmg, +25%% Resist, +50%% Speed, Grab Immunity, See Health, +50 HP</font>"
    UpgradeDescription(6)="<font color=\"#CC8800\">Endless Hunt:</font> After <font color=\"#FFFFFF\">3</font> sets, trophies <font color=\"#FFD700\">stack infinitely</font> in <font color=\"#FFFFFF\">5</font> slots. Per stack: <font color=\"#87CEEB\">Clot</font> +1 Dosh/wave   <font color=\"#87CEEB\">Crawler</font> +1%% Speed   <font color=\"#87CEEB\">Gorefast</font> +1%% Melee   <font color=\"#87CEEB\">Stalker</font> +1%% Mag   <font color=\"#87CEEB\">Bloat</font> +1 HP   <font color=\"#87CEEB\">Husk</font> -0.5%% Taken   <font color=\"#87CEEB\">Siren</font> +5%% Ammo   <font color=\"#87CEEB\">EDAR</font> +10%% Headshot   <font color=\"#87CEEB\">Scrake</font> +5 Armor   <font color=\"#87CEEB\">FP</font> +10%% Dmg   <font color=\"#87CEEB\">Boss</font> ALL"
    ...
    Name="Default__ZTUpgrade_Perk_Predator"
}
