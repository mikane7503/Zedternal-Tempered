...
function AddVenomStack(int SkillLevel)
{
    ...
    // [ZedternalTempered.ZTUpgrade_Skill_VenomExtraction] MaxStacks /
    ...
    if (SkillLevel == 1)
    {
        MaxStacks = class'ZTUpgrade_Skill_VenomExtraction'.default.MaxStacks[0];
        DamagePerStack = class'ZTUpgrade_Skill_VenomExtraction'.default.DamageBonus[0] * 100.0f;
    }
    else
    {
        MaxStacks = class'ZTUpgrade_Skill_VenomExtraction'.default.MaxStacks[1];
        DamagePerStack = class'ZTUpgrade_Skill_VenomExtraction'.default.DamageBonus[1] * 100.0f;
    }
