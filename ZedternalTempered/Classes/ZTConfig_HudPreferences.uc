class ZTConfig_HudPreferences extends Object config(ZedternalUnlimited_Local);

// ===================================================================
// CLIENT-SIDE HUD PREFERENCES
//
// Saved to ZedternalTempered_Local.ini on the client machine.
...
// Initialize rank preferences on first run (called from ZTHudWrapper)
...
defaultproperties
{
	Name="Default__ZTConfig_HudPreferences"
}
