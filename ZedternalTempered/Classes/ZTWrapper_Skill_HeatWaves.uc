...
class ZTWrapper_Skill_HeatWaves extends WMUpgrade_Skill_HeatWaves config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_Stumble = 1.500000f;
		default.Cfg_Damage.Length = 2;
		default.Cfg_Damage[0] = 0.600000f;
		default.Cfg_Damage[1] = 1.500000f;
		default.Cfg_RadiusSQ.Length = 2;
		default.Cfg_RadiusSQ[0] = 90000;
		default.Cfg_RadiusSQ[1] = 360000;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_HeatWaves"
}
