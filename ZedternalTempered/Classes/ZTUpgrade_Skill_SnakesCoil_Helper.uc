class ZTUpgrade_Skill_SnakesCoil_Helper extends Info transient;
...
function TriggerSpeedBoost()
{
    ...
    if (KFPC != None)
    {
        class'ZTMessageManager'.static.SendImportant(KFPC, "Snake's Coil: Speed boost activated! +" $ int(SpeedBoostDuration) $ " seconds");
    }
...
function ShowSpeedBoostEnd()
{
    ...
    if (KFPC != None)
    {
        ...
        class'ZTMessageManager'.static.SendMinor(KFPC, "Snake's Coil: Speed boost ended");
    }
}
...
defaultproperties
{
    ...
    Name="Default__ZTUpgrade_Skill_SnakesCoil_Helper"
}