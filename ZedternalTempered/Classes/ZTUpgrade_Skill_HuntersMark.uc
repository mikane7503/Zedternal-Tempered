// ===================================================================
// ZTUpgrade_Skill_HuntersMark - Speedfreak Blink Strike skill.
//
...
// ===================================================================
class ZTUpgrade_Skill_HuntersMark extends ZTUpgrade_Skill config(ZedternalUnlimited);
...
static function ModifyDamageGiven(out int InDamage, int DefaultDamage, int upgLevel, optional Actor DamageCauser, optional KFPawn_Monster MyKFPM, optional KFPlayerController DamageInstigator, optional class<KFDamageType> DamageType, optional int HitZoneIdx, optional KFWeapon MyKFW)
{
	...
	H = class'ZTUpgrade_Perk_Speedster'.static.FindHelper(DamageInstigator.Pawn);
...
defaultproperties
{
	...
	LocSection="ZTUpgrade_Skill_HuntersMark"
	...
	Name="Default__ZTUpgrade_Skill_HuntersMark"
}
