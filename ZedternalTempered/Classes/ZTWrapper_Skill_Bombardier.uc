// Wrapper for ZedternalReborn.WMUpgrade_Skill_Bombardier
class ZTWrapper_Skill_Bombardier extends WMUpgrade_Skill_Bombardier config(ZedternalUnlimited);
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_Bombardier"
}
