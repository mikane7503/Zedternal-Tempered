...
class ZTWrapper_Skill_TacticalReload extends WMUpgrade_Skill_TacticalReload config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_ReloadRateDeluxe = 0.150000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_TacticalReload"
}
