// ===================================================================
// ZTUpgrade_Perk_Metronome_Helper — Per-Player State Manager
//
// Manages phase rotation, sync kill tracking, permanent bonuses,
// Harmony overlap (L10), Crescendo burst (L20), HUD + sound.
//
// HUD Integration: Reliable client RPCs → ZTHudWrapper.UpdateMetronomeCard()
// Sound Integration: ZTSoundManager → ZTPlayerController.ClientPlayBuffSound()
//
...
// ===================================================================
class ZTUpgrade_Perk_Metronome_Helper extends Info transient;
...
function PostBeginPlay()
{
    ...
    // Load sounds via ZTSoundManager
    foreach Owner.WorldInfo.AllActors(class'ZTMutator', Mutator)
    {
...
function TransitionPhase()
{
    ...
    SyncThreshold = class'ZTUpgrade_Perk_Metronome'.default.SyncKillsForBonus;
    ...
    if (PerkLevel >= class'ZTConfig_Capstone'.default.Capstone_Rank2Level && CurrentPhase == PHASE_ASSAULT)
    {
...
function float GetPermanentBonus(byte Phase)
{
    ...
    BonusPerStack = class'ZTUpgrade_Perk_Metronome'.default.PermanentBonusPerStack;
...
// ===================================================================
// SOUND PLAYBACK — ZTSoundManager pattern
// ===================================================================
...
function PlayMetronomeSound(SoundCue Sound)
{
    ...
    {
        DKPC = ZTPlayerController(KFPawn_Human(Owner).Controller);
        if (DKPC != None)
...
// ===================================================================
// HUD UPDATE — Reliable Client RPC → ZTHudWrapper
// ===================================================================
...
defaultproperties
{
    ...
    Name="Default__ZTUpgrade_Perk_Metronome_Helper"
}
