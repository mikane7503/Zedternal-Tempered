// ===================================================================
// ZTUpgrade_Perk_Speedster - "Blink Strike"
//
...
// invuln window) lives in ZTUpgrade_Perk_Speedster_Helper. This class is the
// upgrade hook surface + helper management + tunables.
// ===================================================================
class ZTUpgrade_Perk_Speedster extends ZTUpgrade_Perk config(ZedternalUnlimited);
...
static function ZTUpgrade_Perk_Speedster_Helper GetHelper(Pawn OwnerPawn)
{
    ...
    {
        foreach OwnerPawn.ChildActors(class'ZTUpgrade_Perk_Speedster_Helper', H)
            return H;
        ...
        H = OwnerPawn.Spawn(class'ZTUpgrade_Perk_Speedster_Helper', OwnerPawn);
        if (H != None)
...
static simulated function ZTUpgrade_Perk_Speedster_Helper FindHelper(Pawn OwnerPawn)
{
    local ZTUpgrade_Perk_Speedster_Helper H;
...
defaultproperties
{
    ...
    LocSection="ZTUpgrade_Perk_Speedster"
    ...
    // Uses the single original UI_Perk_Speedfreak icon.

    Name="Default__ZTUpgrade_Perk_Speedster"
}
