...
class ZTWrapper_Skill_Hunter extends WMUpgrade_Skill_Hunter config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_Vampire.Length = 2;
		default.Cfg_Vampire[0] = 20;
		default.Cfg_Vampire[1] = 60;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_Hunter"
}
