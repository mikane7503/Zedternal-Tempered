class ZTWeap_Rifle_Winchester1894_Neurotox extends KFWeap_Rifle_Winchester1894;
...
DefaultProperties
{
	...
	WeaponProjectiles(DEFAULT_FIREMODE)=class'ZTProj_Bullet_Winchester1894_Neurotox'
	InstantHitDamage(DEFAULT_FIREMODE)=60
	InstantHitDamageTypes(DEFAULT_FIREMODE)=class'ZTDT_Toxic_NeurotoxinRounds'
