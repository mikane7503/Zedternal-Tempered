class ZTUpgrade_Perk_Symbiote_Helper extends Info transient;
...
function ApplyRandomEvolution(KFPlayerController KFPC)
{
    ...
    local ZTHudWrapper SymbioteHUD;
    ...
    if (KFPC != None)
    {
        ...
        SymbioteHUD = class'ZTHudWrapper'.static.GetReaperHUD(KFPC);
        if (SymbioteHUD != None)
        {
...
defaultproperties
{
    ...
    Name="Default__ZTUpgrade_Perk_Symbiote_Helper"
}