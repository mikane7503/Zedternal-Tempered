...
class ZTWrapper_Skill_ImpactRounds extends WMUpgrade_Skill_ImpactRounds config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_Stumble[0] = 0.100000f;
		default.Cfg_Stumble[1] = 0.250000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_ImpactRounds"
}
