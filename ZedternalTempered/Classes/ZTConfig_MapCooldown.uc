// ZTConfig_MapCooldown - Prevents recently played maps from appearing in the vote list
...
class ZTConfig_MapCooldown extends Object config(ZedternalUnlimited);
...
defaultproperties
{
	Name="Default__ZTConfig_MapCooldown"
}
