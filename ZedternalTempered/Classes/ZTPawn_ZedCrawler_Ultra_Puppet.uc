// ===================================================================
// ZTPawn_ZedCrawler_Ultra_Puppet
//
// Puppet Master controllable variant of ZR's WMPawn_ZedCrawler_Ultra (Case A).
// Crawler skeleton -> reuses KFSM_PlayerCrawler_*. Control layer only.
// Stats/mesh/scale/identity stay inherited.
// ===================================================================
class ZTPawn_ZedCrawler_Ultra_Puppet extends WMPawn_ZedCrawler_Ultra;
