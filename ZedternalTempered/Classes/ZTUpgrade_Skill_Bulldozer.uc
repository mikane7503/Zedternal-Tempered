// ===================================================================
// ZTUpgrade_Skill_Bulldozer - Speedfreak general skill (not Blink-specific).
//
...
// ===================================================================
class ZTUpgrade_Skill_Bulldozer extends ZTUpgrade_Skill config(ZedternalUnlimited);
...
defaultproperties
{
	...
	LocSection="ZTUpgrade_Skill_Bulldozer"
	...
	Name="Default__ZTUpgrade_Skill_Bulldozer"
}
