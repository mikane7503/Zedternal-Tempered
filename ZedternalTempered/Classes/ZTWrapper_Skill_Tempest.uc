// Wrapper for ZedternalReborn.WMUpgrade_Skill_Tempest
class ZTWrapper_Skill_Tempest extends WMUpgrade_Skill_Tempest config(ZedternalUnlimited);
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_Tempest"
}
