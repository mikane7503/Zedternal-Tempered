...
class ZTWrapper_Skill_TacticalMovement extends WMUpgrade_Skill_TacticalMovement config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_MoveSpeed = 0.050000f;
		default.Cfg_Speed.Length = 2;
		default.Cfg_Speed[0] = 1.000000f;
		default.Cfg_Speed[1] = 1.150000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_TacticalMovement"
}
