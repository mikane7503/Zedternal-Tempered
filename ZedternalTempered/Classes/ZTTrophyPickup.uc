// ===================================================================
// ZTTrophyPickup - Physical trophy pickup for the Predator perk
//
...
// ===================================================================
class ZTTrophyPickup extends KFDroppedPickup_Cash;

// --- Trophy Data ---
var byte TrophyCategory;
var KFPawn_Human OwnerPawn;
var ZTUpgrade_Perk_Predator_Helper OwnerHelper;
...
function GiveTo(Pawn P)
{
    ...
    bFoundHelper = False;
    foreach KFPH.ChildActors(class'ZTUpgrade_Perk_Predator_Helper', H)
    {
