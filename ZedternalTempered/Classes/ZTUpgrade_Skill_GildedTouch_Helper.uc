// ===================================================================
// ZTUpgrade_Skill_GildedTouch_Helper — Forge Detonation Spawner
//
...
//
// Sound: Plays 'Artificer_Gilded_Touch' on detonation via ZTSoundManager.
// ===================================================================
class ZTUpgrade_Skill_GildedTouch_Helper extends Info;
...
// Called from ZTUpgrade_Skill_GildedTouch.ModifyDamageGiven
// ===================================================================
...
defaultproperties
{
    ...
    Name="Default__ZTUpgrade_Skill_GildedTouch_Helper"
}
