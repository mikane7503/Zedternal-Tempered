...
class ZTWrapper_Skill_AmmoVest extends WMUpgrade_Skill_AmmoVest config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_Ammo[0] = 0.300000f;
		default.Cfg_Ammo[1] = 0.750000f;
		default.Cfg_Weight.Length = 2;
		default.Cfg_Weight[0] = 2;
		default.Cfg_Weight[1] = 5;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_AmmoVest"
}
