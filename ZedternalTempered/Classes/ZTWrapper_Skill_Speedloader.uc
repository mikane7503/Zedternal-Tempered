...
class ZTWrapper_Skill_Speedloader extends WMUpgrade_Skill_Speedloader config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_MinReloadSpeed.Length = 2;
		default.Cfg_MinReloadSpeed[0] = 0.050000f;
		default.Cfg_MinReloadSpeed[1] = 0.125000f;
		default.Cfg_maxReloadSpeed.Length = 2;
		default.Cfg_maxReloadSpeed[0] = 0.200000f;
		default.Cfg_maxReloadSpeed[1] = 0.375000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_Speedloader"
}
