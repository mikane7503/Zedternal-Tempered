// ===================================================================
// ZTPossessorWheelMovie - GFxMoviePlayer for the Possessor form wheel.
//
...
//
// Input model (driven by ZTPlayerController.PossessorPress):
...
//
// Form index order (must match ZTUpgrade_Perk_Possessor_Helper.GetFormClass):
//   0 Clot/Slasher, 1 Crawler, 2 Stalker, 3 Bloat, 4 Gorefast, 5 Siren,
//   6 Husk, 7 Scrake, 8 Fleshpound, 9 Patriarch.
// ===================================================================
class ZTPossessorWheelMovie extends GFxMoviePlayer;
