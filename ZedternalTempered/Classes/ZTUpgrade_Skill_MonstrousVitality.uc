...
class ZTUpgrade_Skill_MonstrousVitality extends ZTUpgrade_Skill config(ZedternalUnlimited);
...
static function AddVampireHealth(out int InHealth, int DefaultHealth, int upgLevel, KFPlayerController KFPC, class<DamageType> DT)
{
	...
	H = class'ZTUpgrade_Perk_JekyllHyde'.static.GetHelper(KFPC.Pawn);
	if (H == None || !H.bHyde)
		return;
...
defaultproperties
{
	...
	LocSection="ZTUpgrade_Skill_MonstrousVitality"
	...
	Name="Default__ZTUpgrade_Skill_MonstrousVitality"
}
