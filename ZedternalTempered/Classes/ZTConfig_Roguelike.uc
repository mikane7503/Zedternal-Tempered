// ===================================================================
// ZTConfig_Roguelike - Server-side roguelike system configuration
//
// Controls the roguelike upgrade selection system.
// Saved to KFZedternalUnlimited.ini
// ===================================================================
class ZTConfig_Roguelike extends Object config(ZedternalUnlimited);
...
defaultproperties
{
	Name="Default__ZTConfig_Roguelike"
}
