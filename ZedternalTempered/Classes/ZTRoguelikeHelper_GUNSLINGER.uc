...
/** Check if burst is currently active (called from ZTPerk for recoil/fire rate) */
...
defaultproperties
{
    ...
    Name="Default__ZTRoguelikeHelper_GUNSLINGER"
}
