// ===================================================================
// ZTConfig_CommandWheel - Per-player command wheel configuration
//
...
//   [ZedternalTempered.ZTConfig_CommandWheel]
...
// ===================================================================
class ZTConfig_CommandWheel extends Object config(ZedternalUnlimited_Local);
...
defaultproperties
{
    Name="Default__ZTConfig_CommandWheel"
}
