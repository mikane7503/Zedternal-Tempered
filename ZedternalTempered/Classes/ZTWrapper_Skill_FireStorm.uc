...
class ZTWrapper_Skill_FireStorm extends WMUpgrade_Skill_FireStorm config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_MeleeSpeed.Length = 2;
		default.Cfg_MeleeSpeed[0] = 0.150000f;
		default.Cfg_MeleeSpeed[1] = 0.400000f;
		default.Cfg_FireRate.Length = 2;
		default.Cfg_FireRate[0] = 0.150000f;
		default.Cfg_FireRate[1] = 0.400000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_FireStorm"
}
