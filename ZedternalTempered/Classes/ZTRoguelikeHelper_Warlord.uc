/**
 * ZTRoguelikeHelper_Warlord — "Iron Curtain"
 * Every 20 kills grants +5 permanent armor (no cap, persists through waves).
* At 200+ total armor, gain an additional +10% damage resistance.
 */
class ZTRoguelikeHelper_Warlord extends ZTRoguelikeHelper;
...
defaultproperties
{
    ...
    MilestonesReached=0
    BonusArmor=0
    Name="Default__ZTRoguelikeHelper_Warlord"
}
