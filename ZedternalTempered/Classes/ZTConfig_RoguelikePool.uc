// ===================================================================
// ZTConfig_RoguelikePool - Roguelike upgrade pool overrides
//
...
// Default values come from ZTRoguelikeUpgradeManager.LoadUpgradePools();
// admins only need to specify what they want to change.
//
// INI section: [ZedternalTempered.ZTConfig_RoguelikePool]
...
// ===================================================================
class ZTConfig_RoguelikePool extends Config_Common config(ZedternalUnlimited);
...
defaultproperties
{
    Name="Default__ZTConfig_RoguelikePool"
}
