// ===================================================================
// ZTUpgrade_Skill_GammaKnife - passive Domain skill.
//
...
// ===================================================================
class ZTUpgrade_Skill_GammaKnife extends ZTUpgrade_Skill config(ZedternalUnlimited);
...
static function ModifyDamageGiven(out int InDamage, int DefaultDamage, int upgLevel, optional Actor DamageCauser, optional KFPawn_Monster MyKFPM, optional KFPlayerController DamageInstigator, optional class<KFDamageType> DamageType, optional int HitZoneIdx, optional KFWeapon MyKFW)
{
	...
	H = class'ZTUpgrade_Perk_Domain'.static.FindHelper(DamageInstigator.Pawn);
...
defaultproperties
{
	...
	LocSection="ZTUpgrade_Skill_GammaKnife"
	...
	Name="Default__ZTUpgrade_Skill_GammaKnife"
}
