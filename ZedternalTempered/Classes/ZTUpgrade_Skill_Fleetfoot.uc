// ===================================================================
// ZTUpgrade_Skill_Fleetfoot - Speedfreak general skill (not Blink-specific).
//
...
// ===================================================================
class ZTUpgrade_Skill_Fleetfoot extends ZTUpgrade_Skill config(ZedternalUnlimited);
...
defaultproperties
{
	...
	LocSection="ZTUpgrade_Skill_Fleetfoot"
	...
	Name="Default__ZTUpgrade_Skill_Fleetfoot"
}
