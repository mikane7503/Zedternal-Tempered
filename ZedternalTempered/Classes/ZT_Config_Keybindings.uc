// ===================================================================
// ZT_Config_Keybindings - Stores default keybindings for the mod
// Auto-applies keybindings on first join, saves state per-user
// ===================================================================
class ZT_Config_Keybindings extends Object config(ZedternalUnlimited_Local);
...
static function InitializeDefaults(out ZT_Config_Keybindings Config)
{
...
static function bool EnsureBind(out ZT_Config_Keybindings Config, string KeyName, string Command, string Description)
{
    local int i;
