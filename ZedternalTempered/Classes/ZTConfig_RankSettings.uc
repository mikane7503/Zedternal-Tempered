// ===================================================================
// ZTConfig_RankSettings - Server-side rank system configuration
//
// Controls how the rank system operates on this server.
// Saved to KFZedternalUnlimited.ini
// ===================================================================
class ZTConfig_RankSettings extends Object config(ZedternalUnlimited);
...
defaultproperties
{
	Name="Default__ZTConfig_RankSettings"
}
