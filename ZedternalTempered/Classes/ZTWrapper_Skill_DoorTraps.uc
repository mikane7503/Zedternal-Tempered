...
class ZTWrapper_Skill_DoorTraps extends WMUpgrade_Skill_DoorTraps config(ZedternalUnlimited);
...
static function UpdateConfig()
{
	if (default.MODEVERSION < 1)
	{
		...
		default.Cfg_Bonus[0] = 0.750000f;
		default.Cfg_Bonus[1] = 2.000000f;
...
defaultproperties
{
	Name="Default__ZTWrapper_Skill_DoorTraps"
}
