// ===================================================================
// ZTConfig_WeaponUpgradeVisibility
//
// CLIENT-SIDE preference config for hiding weapon upgrades in the
// UPG Menu. Saved to KFZedternalTempered_Local.ini.
//
...
// ===================================================================
class ZTConfig_WeaponUpgradeVisibility extends Object config(ZedternalUnlimited_Local);
...
//
// Called once per UPG Menu open — cached in ZTUI_UPGMenu.
// ===================================================================
...
defaultproperties
{
	Name="Default__ZTConfig_WeaponUpgradeVisibility"
}
