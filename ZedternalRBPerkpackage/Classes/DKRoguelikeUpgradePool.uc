 ...
 */
class DKRoguelikeUpgradePool extends Object;
...
defaultproperties
{
	...
	UniversalUpgrades.Add((UpgradeID="UNIV_R_RESIST", DisplayName="Resilient", Description="-5% Damage Taken", Rarity=RLR_Rare, PoolType=RLPT_Universal, StatType=RLST_DamageResist, StatValue=0.05, bIsPercentage=true))
	...
	UniversalUpgrades.Add((UpgradeID="UNIV_E_RESIST", DisplayName="Stalwart", Description="-8% Damage Taken", Rarity=RLR_Epic, PoolType=RLPT_Universal, StatType=RLST_DamageResist, StatValue=0.08, bIsPercentage=true))
	...
	UniversalUpgrades.Add((UpgradeID="UNIV_L_RESIST", DisplayName="Unbreakable", Description="-12% Damage Taken", Rarity=RLR_Legendary, PoolType=RLPT_Universal, StatType=RLST_DamageResist, StatValue=0.12, bIsPercentage=true))
	...
	Name="Default__DKRoguelikeUpgradePool"
}
