// ===================================================================
// DKAchievementData - Achievement Definitions and Configuration
// Defines all achievements, requirements, and perk unlocks
// ===================================================================
class DKAchievementData extends Object;
...
{
	`log("DKAchievementData: Initializing achievements...");
	...
	`log("DKAchievementData: Initialized" @ Achievements.Length @ "achievements");
	LogAllAchievements();
}
...
function LogAllAchievements()
{
	...
	`log("===== DKAchievementData: Achievement List =====");
	for (i = 0; i < Achievements.Length; i++)
	{
		Ach = Achievements[i];
...
defaultproperties
{
	...
	Name="Default__DKAchievementData"
}