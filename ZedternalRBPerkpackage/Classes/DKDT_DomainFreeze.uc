// ===================================================================
// DKDT_DomainFreeze - cryo damage type for the Domain "Stasis" ability.
//
...
// ===================================================================
class DKDT_DomainFreeze extends KFDT_Freeze_FreezeGrenade
	abstract
	hidedropdown;
...
defaultproperties
{
	...
	Name="Default__DKDT_DomainFreeze"
}
