// ===================================================================
// DKUpgrade_Perk_Possessor - "Possession"
//
...
// lives in DKUpgrade_Perk_Possessor_Helper. The actual possess / park /
// revert machinery is DKPlayerController's puppet path. This class is the
// upgrade hook surface + helper management + tunables.
// ===================================================================
class DKUpgrade_Perk_Possessor extends DKUpgrade_Perk
...
static function DKUpgrade_Perk_Possessor_Helper GetHelper(Pawn OwnerPawn)
{
    ...
    {
        foreach OwnerPawn.ChildActors(class'DKUpgrade_Perk_Possessor_Helper', H)
            return H;
        ...
        H = OwnerPawn.Spawn(class'DKUpgrade_Perk_Possessor_Helper', OwnerPawn);
        if (H != None)
...
static simulated function DKUpgrade_Perk_Possessor_Helper FindHelper(Pawn OwnerPawn)
{
    local DKUpgrade_Perk_Possessor_Helper H;
...
// Wired from DKGameInfo_Endless / _AllWeapons Killed() next to the
...
defaultproperties
{
    ...
    LocSection="DKUpgrade_Perk_Possessor"
    ...
    UpgradeIcon(0)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_0'
    UpgradeIcon(1)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_1'
    UpgradeIcon(2)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_2'
    UpgradeIcon(3)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_3'
    UpgradeIcon(4)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_4'
    UpgradeIcon(5)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(6)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(7)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(8)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(9)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(10)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(11)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(12)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(13)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(14)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(15)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(16)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(17)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(18)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(19)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'
    UpgradeIcon(20)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Possessor_Rank_5'

    Name="Default__DKUpgrade_Perk_Possessor"
}
