// ===================================================================
// DKWish_Buff - Wishmaster effect carrier, attached to the WISH TARGET
...
// DKGameInfo_Endless(.ReduceDamage) - MIRRORED in both GameInfos.
//
// Wave-scoped effects expire when the trader opens again.
// ===================================================================
class DKWish_Buff extends Actor;
