class DKUpgrade_Skill_GorgonsLegacy_Helper extends Info
    transient;
...
function ActivateLegacyBuff(int SkillLevel)
{
    ...
    class'DKMessageManager'.static.SendCritical(KFPC, "Gorgon's Legacy: Inherited power! +" $ (SkillLevel == 1 ? 25 : 50) $ "% damage for " $ int(Duration) $ " seconds!");
}
...
function ActivateInvincibility()
{
    ...
    if (KFPC != None)
    {
        ...
        class'DKMessageManager'.static.SendCritical(KFPC, "Gorgon's Legacy: Brief invincibility granted!");
    }
}
...
function DeactivateLegacyBuff()
{
    ...
    if (KFPC != None)
    {
        ...
        class'DKMessageManager'.static.SendMinor(KFPC, "Gorgon's Legacy: Power fades...");
    }
}
...
function DeactivateInvincibility()
{
    ...
    {
        // Minor - buff expiration
        class'DKMessageManager'.static.SendMinor(KFPC, "Gorgon's Legacy: Invincibility ended");
    }
}
...
function TriggerLegacyOnDeath()
{
    ...
    class'DKUpgrade_Skill_GorgonsLegacy'.static.TriggerGorgonsLegacy(Player, UpgradeLevel);
}
...
defaultproperties
{
    ...
    Name="Default__DKUpgrade_Skill_GorgonsLegacy_Helper"
}