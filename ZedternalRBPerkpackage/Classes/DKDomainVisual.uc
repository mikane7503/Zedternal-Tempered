// ===================================================================
// DKDomainVisual - cosmetic translucent dome for the Domain room.
//
// Server-spawned by DKUpgrade_Perk_Domain_Helper.CastRoom at the room centre;
...
// ===================================================================
class DKDomainVisual extends Actor;
