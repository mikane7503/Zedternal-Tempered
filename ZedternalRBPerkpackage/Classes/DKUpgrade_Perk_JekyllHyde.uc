// ===================================================================
// DKUpgrade_Perk_JekyllHyde - "The Duality"
//
...
// lives in DKUpgrade_Perk_JekyllHyde_Helper. This class is the upgrade
// hook surface + helper management.
// ===================================================================
class DKUpgrade_Perk_JekyllHyde extends DKUpgrade_Perk
...
static function UpdateConfig()
{
    ...
    // otherwise read as full immunity in DKPerk, so we force it here).
...
static function DKUpgrade_Perk_JekyllHyde_Helper GetHelper(Pawn OwnerPawn)
{
    local DKUpgrade_Perk_JekyllHyde_Helper H;

    if (KFPawn_Human(OwnerPawn) != None)
    {
        foreach OwnerPawn.ChildActors(class'DKUpgrade_Perk_JekyllHyde_Helper', H)
            return H;

        H = OwnerPawn.Spawn(class'DKUpgrade_Perk_JekyllHyde_Helper', OwnerPawn);
    }
...
static simulated function DKUpgrade_Perk_JekyllHyde_Helper FindHelper(Pawn OwnerPawn)
{
    local DKUpgrade_Perk_JekyllHyde_Helper H;
...
// last step of DKPerk.ModifyDamageTaken so it lands after every other
...
defaultproperties
{
    ...
    LocSection="DKUpgrade_Perk_JekyllHyde"
    ...
    UpgradeIcon(0)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_0'
    UpgradeIcon(1)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_1'
    UpgradeIcon(2)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_2'
    UpgradeIcon(3)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_3'
    UpgradeIcon(4)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_4'
    UpgradeIcon(5)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(6)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(7)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(8)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(9)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(10)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(11)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(12)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(13)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(14)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(15)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(16)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(17)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(18)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(19)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'
    UpgradeIcon(20)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_JekyllHyde_Legacy_Rank_5'

    Name="Default__DKUpgrade_Perk_JekyllHyde"
}
