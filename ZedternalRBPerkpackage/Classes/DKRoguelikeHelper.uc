 ...
 * DKPerk iterates ChildActors of this type to apply bonuses.
 *
 * Naming convention: PERK_X_BERSERKER -> DKRoguelikeHelper_Berserker
 */
class DKRoguelikeHelper extends Actor;
...
// Called from DKPerk.ModifyDamageGiven() foreach iteration
// ===================================================================
...
// Called from DKPerk.ModifyDamageTaken() foreach iteration
// ===================================================================
...
// Called from DKPerk.WaveEnd() or GameInfo wave transitions
// ===================================================================
...
defaultproperties
{
    ...
    Name="Default__DKRoguelikeHelper"
}
