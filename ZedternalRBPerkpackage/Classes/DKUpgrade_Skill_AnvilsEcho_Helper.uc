// ===================================================================
// DKUpgrade_Skill_AnvilsEcho_Helper — Hit Counter for Phantom Echo
//
...
//
// Sound: Plays 'Artificer_Anvils_Echo' on proc via DKSoundManager.
// ===================================================================
class DKUpgrade_Skill_AnvilsEcho_Helper extends Info;
...
// ===================================================================
// ON HIT — Called from DKUpgrade_Skill_AnvilsEcho.ModifyDamageGiven
...
function OnHit(out int InDamage, int DefaultDamage, int upgLevel)
{
    ...
    Interval = class'DKUpgrade_Skill_AnvilsEcho'.default.HitInterval[upgLevel - 1];
    if (Interval <= 0)
        return;
    ...
    if ((TotalHits % Interval) == 0)
    {
        ...
        EchoBonus = class'DKUpgrade_Skill_AnvilsEcho'.default.EchoDamage;
...
defaultproperties
{
    ...
    Name="Default__DKUpgrade_Skill_AnvilsEcho_Helper"
}
