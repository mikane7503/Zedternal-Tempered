// ===================================================================
// DKSpecialWave_BloatKings - Boss Rush: 10 Bloat Kings
// ===================================================================
class DKSpecialWave_BloatKings extends WMSpecialWave;
...
function PostBeginPlay()
{
	...
	if (GameMutator != None)
	{
		...
		`log("DKSpecialWave_BloatKings: Started boss wave tracking");
	}
...
function SpawnBossGroups()
{
	...
	`log("DKSpecialWave_BloatKings: Spawned 10 Bloat Kings in 2 groups");
}

function WaveEnded()
{
	`log("DKSpecialWave_BloatKings: Wave ended");
	super.WaveEnded();
}
...
defaultproperties
{
	...
	Name="Default__DKSpecialWave_BloatKings"
}