// ===================================================================
// DKUpgrade_Skill_Overforge_Helper — Hit Stack Tracker
//
...
//
// Sound: Plays 'Artificer_Overforge_Strike' on burst via DKSoundManager.
// ===================================================================
class DKUpgrade_Skill_Overforge_Helper extends Info;
...
// ===================================================================
// ON HIT — Called from DKUpgrade_Skill_Overforge.ModifyDamageGiven
...
function OnHit(KFWeapon KFW, out int InDamage, int DefaultDamage, int upgLevel)
{
    ...
    Threshold = class'DKUpgrade_Skill_Overforge'.default.StackThreshold;
    ...
    if (HitStacks >= Threshold)
    {
        ...
        BurstBonus = class'DKUpgrade_Skill_Overforge'.default.BurstDamage[upgLevel - 1];
...
defaultproperties
{
    ...
    Name="Default__DKUpgrade_Skill_Overforge_Helper"
}
