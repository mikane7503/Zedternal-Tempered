// ===================================================================
// DKPawn_ZedScrake_Tiny_Puppet
//
// Puppet Master controllable variant of ZR's WMPawn_ZedScrake_Tiny (Case A).
// Scrake skeleton -> reuses KFSM_PlayerScrake_*. Control layer only.
// Stats/mesh/identity (incl. the tiny scale) stay inherited.
// ===================================================================
class DKPawn_ZedScrake_Tiny_Puppet extends WMPawn_ZedScrake_Tiny;
