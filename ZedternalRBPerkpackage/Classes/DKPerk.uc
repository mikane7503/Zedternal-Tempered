// ===================================================================
// DKPerk - Extended perk system with roguelike upgrade stat integration
...
function DKPlayerReplicationInfo GetDKPRI()
{
    local DKPlayerController DKPC;

    DKPC = DKPlayerController(OwnerPC);
    if (DKPC != None)
    {
        return DKPlayerReplicationInfo(DKPC.PlayerReplicationInfo);
    }
...
simulated function DKPlayerReplicationInfo GetDKPRISimulated()
{
    local DKPlayerController DKPC;
...
// at the top — virtual dispatch resolves our override on a DKPerk
...
// See DKConfig_PlayerCaps.
// ===================================================================

// Absolute upper bound on an int stat.
final function DKCapAbsInt(out int Val, int CapVal)
{
    if (CapVal > 0 && Val > CapVal && class'DKConfig_PlayerCaps'.static.IsEnabled())
        Val = CapVal;
}
...
{
    if (CapVal > 0.0 && Val > CapVal && class'DKConfig_PlayerCaps'.static.IsEnabled())
        Val = CapVal;
}
...
{
    if (MinVal > 0 && Val < MinVal && class'DKConfig_PlayerCaps'.static.IsEnabled())
        Val = MinVal;
}
...
final function DKCapMinAbsIntToBase(out int Val, int MinVal, int InBase)
{
    ...
    if (MinVal > 0 && InBase > 0 && class'DKConfig_PlayerCaps'.static.IsEnabled())
    {
...
final function DKCapMaxMultInt(out int Val, int InBase, float MaxMult)
{
    ...
    if (MaxMult > 0.0 && InBase > 0 && class'DKConfig_PlayerCaps'.static.IsEnabled())
    {
...
final function DKCapMaxMultFloat(out float Val, float InBase, float MaxMult)
{
    if (MaxMult > 0.0 && InBase > 0.0 && Val > InBase * MaxMult
        && class'DKConfig_PlayerCaps'.static.IsEnabled())
        Val = InBase * MaxMult;
}
...
final function DKCapMinScaleInt(out int Val, int InBase, float MinScale)
{
    ...
    if (MinScale > 0.0 && InBase > 0 && class'DKConfig_PlayerCaps'.static.IsEnabled())
    {
...
function ModifyHealth(out int InHealth)
{
    ...
    local int i, idx;
    local DKUpgrade_Skill_MementoMori_Helper MMHelper;
    ...
    if (OwnerPawn != None)
    {
        foreach OwnerPawn.ChildActors(class'DKUpgrade_Skill_MementoMori_Helper', MMHelper)
        {
    ...
    DKCapAbsInt(InHealth, class'DKConfig_PlayerCaps'.static.GetCapMaxHealth());

    // === PLAYERCAPS: absolute min health floor (applied after the max) ===
    DKCapMinAbsInt(InHealth, class'DKConfig_PlayerCaps'.static.GetCapMinHealth());
}
...
function ModifyArmorInt(out int MaxArmor)
{
    ...
    DKCapAbsInt(MaxArmor, class'DKConfig_PlayerCaps'.static.GetCapMaxArmor());

    // === PLAYERCAPS: absolute min armor floor (applied after the max) ===
    DKCapMinAbsInt(MaxArmor, class'DKConfig_PlayerCaps'.static.GetCapMinArmor());
}
...
function ModifyDamageGiven(out int InDamage, optional Actor DamageCauser, optional KFPawn_Monster MyKFPM, optional KFPlayerController DamageInstigator, optional class<KFDamageType> DamageType, optional int HitZoneIdx)
{
    ...
    local DKRoguelikeHelper RLHelper;
    local int i, idx;
    ...
    if (OwnerPawn != None)
    {
        foreach OwnerPawn.ChildActors(class'DKRoguelikeHelper', RLHelper)
        {
    ...
    if (OrigInDamage > 0 && class'DKConfig_PlayerCaps'.static.IsEnabled())
    {
        EffDmgCap = class'DKConfig_PlayerCaps'.static.GetCapDamageGivenMultiplier();

        if (MyKFPM != None && MyKFPM.IsLargeZed())
        {
            LargeCap = class'DKConfig_PlayerCaps'.static.GetCapDamageToLargeMultiplier();
        ...
        {
            HeadCap = class'DKConfig_PlayerCaps'.static.GetCapHeadshotDamageMultiplier();
...
simulated function float GetReloadRateScale(KFWeapon KFW)
{
    ...
    DKCapMinScaleFloat(Result, 1.0, class'DKConfig_PlayerCaps'.static.GetCapReloadRateMinScale());
...
simulated function ModifySpareAmmoAmount(KFWeapon KFW, out int PrimarySpareAmmo, optional const out STraderItem TraderItem, optional bool bSecondary = False)
{
    ...
    DKCapMaxMultInt(PrimarySpareAmmo, BaseSpareAmmo, class'DKConfig_PlayerCaps'.static.GetCapSpareAmmoMultiplier());
}
...
simulated function ModifySpeed(out float Speed)
{
    ...
    DKCapMaxMultFloat(Speed, OrigSpeed, class'DKConfig_PlayerCaps'.static.GetCapSpeedMultiplier());
}
...
simulated function ModifyRateOfFire(out float InRate, KFWeapon KFW)
{
    ...
    DKCapMinScaleFloat(InRate, OrigInRate, class'DKConfig_PlayerCaps'.static.GetCapRateOfFireMinScale());
...
simulated function ModifyMeleeAttackSpeed(out float InDuration, KFWeapon KFW)
{
    ...
    DKCapMinScaleFloat(InDuration, OrigInDuration, class'DKConfig_PlayerCaps'.static.GetCapMeleeAttackSpeedMinDuration());
...
simulated function ModifyWeaponSwitchTime(out float ModifiedSwitchTime)
{
    ...
    DKCapMinScaleFloat(ModifiedSwitchTime, OrigSwitchTime, class'DKConfig_PlayerCaps'.static.GetCapWeaponSwitchMinScale());
...
function ModifyDamageTaken(out int InDamage, optional class<DamageType> DamageType, optional Controller InstigatedBy)
{
    ...
    local DKUpgrade_Perk_JekyllHyde_Helper HydeHelper;
    ...
    {
        HydeMult = class'DKUpgrade_Perk_JekyllHyde'.default.HydeFinalDamageTakenMult;
        if (HydeMult > 0.0f && HydeMult < 1.0f)
        {
            foreach OwnerPawn.ChildActors(class'DKUpgrade_Perk_JekyllHyde_Helper', HydeHelper)
            {
                if (HydeHelper.bHyde)
                {
...
function ModifyHardAttackDamage(out int InDamage)
{
    ...
    DKCapMaxMultInt(InDamage, OrigInDamage, class'DKConfig_PlayerCaps'.static.GetCapHardAttackDamageMultiplier());
}
...
function bool ModifyHealAmount(out float HealAmount)
{
    ...
    DKCapMaxMultFloat(HealAmount, OrigHealAmount, class'DKConfig_PlayerCaps'.static.GetCapHealAmountMultiplier());
...
simulated function ModifyRecoil(out float CurrentRecoilModifier, KFWeapon KFW)
{
    ...
    DKCapMinScaleFloat(CurrentRecoilModifier, OrigRecoil, class'DKConfig_PlayerCaps'.static.GetCapRecoilMinScale());
...
simulated function ModifySpread(out float InSpread)
{
    ...
    DKCapMinScaleFloat(InSpread, OrigSpread, class'DKConfig_PlayerCaps'.static.GetCapSpreadMinScale());
...
simulated function ModifyMagSizeAndNumber(KFWeapon KFW, out int MagazineCapacity, optional array< class<KFPerk> > WeaponPerkClass, optional bool bSecondary = False, optional name WeaponClassname)
{
    ...
    DKCapMaxMultInt(MagCapacity, OrigMagazineCapacity, class'DKConfig_PlayerCaps'.static.GetCapMagSizeMultiplier());
    ...
    DKCapMinAbsIntToBase(MagCapacity, class'DKConfig_PlayerCaps'.static.GetCapMinMagSize(), OrigMagazineCapacity);
...
simulated function ModifyMaxSpareGrenadeAmount()
{
    ...
    DKCapAbsInt(SpareGrenade, class'DKConfig_PlayerCaps'.static.GetCapMaxSpareGrenades());
...
function ApplyWeightLimits()
{
    ...
    DKCapAbsInt(InWeightLimit, class'DKConfig_PlayerCaps'.static.GetCapCarryWeight());
...
simulated function float GetPenetrationModifier(byte Level, class<KFDamageType> DamageType, optional bool bForce)
{
    ...
    DKCapAbsFloat(InPenetration, class'DKConfig_PlayerCaps'.static.GetCapPenetrationMax());
...
function float GetStunPowerModifier(optional class<DamageType> DamageType, optional byte HitZoneIdx)
{
    ...
    DKCapAbsFloat(InStunPower, class'DKConfig_PlayerCaps'.static.GetCapStunPowerMax());
...
function float GetStumblePowerModifier(optional KFPawn KFP, optional class<KFDamageType> DamageType, optional out float CooldownModifier, optional byte BodyPart)
{
    ...
    DKCapAbsFloat(InStumblePower, class'DKConfig_PlayerCaps'.static.GetCapStumblePowerMax());
...
function float GetKnockdownPowerModifier(optional class<DamageType> DamageType, optional byte BodyPart, optional bool bIsSprinting = False)
{
    ...
    DKCapAbsFloat(InKnockdownPower, class'DKConfig_PlayerCaps'.static.GetCapKnockdownPowerMax());
...
simulated function float GetSnarePowerModifier(optional class<DamageType> DamageType, optional byte HitZoneIdx)
{
    ...
    if (class'DKConfig_PlayerCaps'.static.IsEnabled()
        && class'DKConfig_PlayerCaps'.static.GetCapSnarePowerMax() > 0.0
        && (InSnarePower - 1.0f) > class'DKConfig_PlayerCaps'.static.GetCapSnarePowerMax())
    {
        InSnarePower = class'DKConfig_PlayerCaps'.static.GetCapSnarePowerMax() + 1.0f;
    }
...
simulated function ModifyMaxDeployed(out int CurrentMaxDeployed, KFWeapon KFW)
{
    ...
    DKCapAbsInt(CurrentMaxDeployed, class'DKConfig_PlayerCaps'.static.GetCapMaxDeployedTurrets());
}
