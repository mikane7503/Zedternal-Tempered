// ===================================================================
// DKPawn_ZedCrawler_Medium_Puppet
//
// Puppet Master controllable variant of ZR's WMPawn_ZedCrawler_Medium (Case A).
// Crawler skeleton -> reuses KFSM_PlayerCrawler_*. Control layer only.
// Stats/mesh/scale/identity stay inherited.
// ===================================================================
class DKPawn_ZedCrawler_Medium_Puppet extends WMPawn_ZedCrawler_Medium;
