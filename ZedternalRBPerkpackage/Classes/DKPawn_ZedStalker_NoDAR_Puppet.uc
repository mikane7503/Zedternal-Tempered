// ===================================================================
// DKPawn_ZedStalker_NoDAR_Puppet
//
// Puppet Master controllable variant of ZR's WMPawn_ZedStalker_NoDAR (Case A).
// Rides the Stalker skeleton -> reuses the stock Stalker player kit
// (KFSM_PlayerStalker_Melee / _Melee2 / _Roll). Control layer only, copied from
// KFPawn_ZedStalker_Versus; the cloak-spotting override functions are skipped
// (polish only). Stats/mesh/identity stay inherited.
// ===================================================================
class DKPawn_ZedStalker_NoDAR_Puppet extends WMPawn_ZedStalker_NoDAR;
