// ===================================================================
// DKUpgrade_Weapon - Intermediate base class for all DK weapon upgrades.
//
// Provides:
//   1. Localization support via the smart-fallback pattern (mirrors
//      DKUpgrade_Perk and DKUpgrade_Skill).
...
//
// All DK weapon upgrade leaf classes (DKUpgrade_Weapon_* and DKWeaponUpg_*)
...
// ===================================================================
class DKUpgrade_Weapon extends WMUpgrade_Weapon
	abstract;
...
//   LocSection="DKUpgrade_Weapon_<Name>"  (or "DKWeaponUpg_<Name>")
...
static function string GetUpgradeDescription()
{
	...
	return class'DKLocalizationHelper'.static.TryLocalize(default.LocPackage, default.LocSection, "WeaponUpgradeDescription", Fallback);
}

defaultproperties
{
	Name="Default__DKUpgrade_Weapon"
}
