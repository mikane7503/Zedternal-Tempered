...
class DKUpgrade_Skill_DesignatedHitter extends DKUpgrade_Skill
...
static function DKUpgrade_Skill_DesignatedHitter_Helper GetHelper(Pawn OwnerPawn)
{
	local DKUpgrade_Skill_DesignatedHitter_Helper H;

	if (KFPawn_Human(OwnerPawn) == None)
		return None;

	foreach OwnerPawn.ChildActors(class'DKUpgrade_Skill_DesignatedHitter_Helper', H)
		return H;

	return OwnerPawn.Spawn(class'DKUpgrade_Skill_DesignatedHitter_Helper', OwnerPawn);
}
...
defaultproperties
{
	...
	LocSection="DKUpgrade_Skill_DesignatedHitter"
	...
	Name="Default__DKUpgrade_Skill_DesignatedHitter"
}
