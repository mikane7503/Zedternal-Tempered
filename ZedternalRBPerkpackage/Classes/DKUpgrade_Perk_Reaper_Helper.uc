class DKUpgrade_Perk_Reaper_Helper extends Info
    transient;
...
function ShowInstantKillNotification()
{
    ...
    if (KFPC != None)
    {
        ...
        ReaperHUD = class'DKHudWrapper'.static.GetReaperHUD(KFPC);
        if (ReaperHUD != None)
        {
...
defaultproperties
{
    ...
    Name="Default__DKUpgrade_Perk_Reaper_Helper"
}