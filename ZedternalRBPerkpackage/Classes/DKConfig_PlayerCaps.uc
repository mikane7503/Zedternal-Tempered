// ===================================================================
// DKConfig_PlayerCaps - Server-side player stat caps
// INI: ZedternalRBPerkpackage_ZedternalUnlimited (config(ZedternalUnlimited))
...
// very end of each DKPerk stat hook, so they win over every bonus source.
// ===================================================================
class DKConfig_PlayerCaps extends Object
...
static function CheckBasicConfigValues()
{
	...
	if (bDirty)
	{
		`log("[DKConfig_PlayerCaps] Reset one or more negative cap values to 0 (disabled)");
		StaticSaveConfig();
	}
}
...
defaultproperties
{
	Name="Default__DKConfig_PlayerCaps"
}
