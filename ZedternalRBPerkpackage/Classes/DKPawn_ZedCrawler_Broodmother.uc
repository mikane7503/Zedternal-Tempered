...
// ===================================================================
class DKPawn_ZedCrawler_Broodmother extends KFPawn_ZedCrawlerKing;
...
{
	local DKPawn_ZedCrawler_Broodmother OtherBrood;
	...
	{
		foreach WorldInfo.AllPawns(class'DKPawn_ZedCrawler_Broodmother', OtherBrood)
		{
...
{
	local DKAIController_ZedCrawler_Broodmother BroodAI;
	...
	BroodAI = DKAIController_ZedCrawler_Broodmother(Controller);
	if (BroodAI != None)
	{
...
defaultproperties
{
	ControllerClass=class'ZedternalRBPerkpackage.DKAIController_ZedCrawler_Broodmother'
	DifficultySettings=class'ZedternalRBPerkpackage.DKDifficulty_Crawler_Broodmother'
	...
	Name="Default__DKPawn_ZedCrawler_Broodmother"
}
