...
class DKUpgrade_Skill_Checksum_Helper extends Actor;
...
function RollBuff()
{
	...
	class'DKMessageManager'.static.SendMinor(KFPlayerController(KFPH.Controller),
...
defaultproperties
{
	...
	Name="Default__DKUpgrade_Skill_Checksum_Helper"
}
