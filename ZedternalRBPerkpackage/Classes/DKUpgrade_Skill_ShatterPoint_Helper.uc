// ===================================================================
// DKUpgrade_Skill_ShatterPoint_Helper — Per-Target Damage Tracker
//
...
//
// Sound: Plays 'Artificer_Shatter_Point' on proc via DKSoundManager.
// ===================================================================
class DKUpgrade_Skill_ShatterPoint_Helper extends Info;
...
// ===================================================================
// ON HIT — Called from DKUpgrade_Skill_ShatterPoint.ModifyDamageGiven
...
function OnHit(KFPawn_Monster Target, out int InDamage, int DefaultDamage, int upgLevel)
{
    ...
    Threshold = float(Fractures[Idx].TargetMaxHP) * class'DKUpgrade_Skill_ShatterPoint'.default.DamageThreshold[upgLevel - 1];

    // Check if we've crossed the threshold
    if (Fractures[Idx].DamageDealt >= Threshold)
    {
        // SHATTER POINT — calculate burst damage as % of target's max HP
        BurstPct = class'DKUpgrade_Skill_ShatterPoint'.default.BurstPercent[upgLevel - 1];
...
defaultproperties
{
    ...
    Name="Default__DKUpgrade_Skill_ShatterPoint_Helper"
}
