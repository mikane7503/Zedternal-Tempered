// ===================================================================
// DKUpgrade_Perk_Predator_Helper - Trophy collection state machine
//
...
// ===================================================================
class DKUpgrade_Perk_Predator_Helper extends Actor;
...
var array<DKTrophyPickup> LivePickups;
...
function OnZedKilled(KFPawn_Monster Victim)
{
    ...
    // --- Spawn pickup ---
    Pickup = Spawn(class'DKTrophyPickup', Player.Controller, , Victim.Location, , , True);
...
function float GetDropChance()
{
    ...
    if (PerkLevel >= class'DKConfig_Capstone'.default.Capstone_Rank1Level && PerkLevel < class'DKConfig_Capstone'.default.Capstone_Rank2Level)
        Chance *= 2.0f;
...
// ===================================================================
// TROPHY COLLECTION (called by DKTrophyPickup)
// ===================================================================
...
function OnPickupDestroyed(DKTrophyPickup Pickup)
{
    if (Pickup != None)
    {
...
function SendDisplayUpdate()
{
    ...
    bRepTrophyMaster = PerkLevel >= class'DKConfig_Capstone'.default.Capstone_Rank2Level;
    ...
    if (WorldInfo.NetMode != NM_Standalone)
    {
        ClientUpdatePredatorDisplay(Pack1, Pack2, Pack3,
            ...
            PerkLevel >= class'DKConfig_Capstone'.default.Capstone_Rank2Level,
            bStackingPhase,
...
defaultproperties
{
    ...
    Name="Default__DKUpgrade_Perk_Predator_Helper"
}
