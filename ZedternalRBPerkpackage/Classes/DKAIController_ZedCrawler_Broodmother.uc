// ===================================================================
// DKAIController_ZedCrawler_Broodmother
// Custom AI controller for the Broodmother crawler.
// When fleeing, prevents attacks and sprints away from players.
// ===================================================================
class DKAIController_ZedCrawler_Broodmother extends KFAIController_ZedCrawlerKing;

var DKPawn_ZedCrawler_Broodmother BroodPawn;

event Possess(Pawn inPawn, bool bVehicleTransition)
{
	super.Possess(inPawn, bVehicleTransition);
	BroodPawn = DKPawn_ZedCrawler_Broodmother(inPawn);
}
...
defaultproperties
{
	...
	Name="Default__DKAIController_ZedCrawler_Broodmother"
}
