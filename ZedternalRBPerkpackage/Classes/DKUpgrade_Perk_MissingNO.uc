// ===================================================================
// DKUpgrade_Perk_MissingNO - "The Living Glitch"
...
// ===================================================================
class DKUpgrade_Perk_MissingNO extends DKUpgrade_Perk
...
static function DKUpgrade_Perk_MissingNO_Helper GetHelper(Pawn OwnerPawn)
{
	local DKUpgrade_Perk_MissingNO_Helper Helper;

	if (OwnerPawn == None)
		return None;

	foreach OwnerPawn.ChildActors(class'DKUpgrade_Perk_MissingNO_Helper', Helper)
		return Helper;
...
static simulated function InitiateWeapon(int upgLevel, KFWeapon KFW, KFPawn OwnerPawn)
{
	...
	// Spawn new helper
	Helper = OwnerPawn.Spawn(class'DKUpgrade_Perk_MissingNO_Helper', OwnerPawn);
	if (Helper != None)
	{
		Helper.SetUpgradeLevel(upgLevel);
...
static function class<KFDamageType> GetRotatingDT(int Index)
{
	switch (Index)
	{
		case 0: return class'DKDT_InfernoRounds';
		case 1: return class'DKDT_BlackIce';
		case 2: return class'DKDT_ToxicOverload';
		case 3: return class'DKDT_Thermite';
		case 4: return class'DKDT_Hypothermia';
	}
	return None;
}
...
{
	return DT == class'DKDT_InfernoRounds'
		|| DT == class'DKDT_BlackIce'
		|| DT == class'DKDT_ToxicOverload'
		|| DT == class'DKDT_Thermite'
		|| DT == class'DKDT_Hypothermia';
}
...
defaultproperties
{
	...
	LocSection="DKUpgrade_Perk_MissingNO"
	...
	// --- Icons (21 ranks: 0-20) ---
	UpgradeIcon(0)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_0'
	UpgradeIcon(1)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_1'
	UpgradeIcon(2)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_2'
	UpgradeIcon(3)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_3'
	UpgradeIcon(4)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_4'
	UpgradeIcon(5)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(6)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(7)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(8)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(9)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(10)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(11)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(12)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(13)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(14)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(15)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(16)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(17)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(18)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(19)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'
	UpgradeIcon(20)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_MissingNO_Legacy_Rank_5'

	// --- Legacy (hand-made) artwork - empty until art is created ---

	Name="Default__DKUpgrade_Perk_MissingNO"
}
