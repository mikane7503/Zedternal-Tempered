// ===================================================================
// DKSpecialWave_FleshpoundKings - Boss Rush: 10 Fleshpound Kings
// ===================================================================
class DKSpecialWave_FleshpoundKings extends WMSpecialWave;
...
function PostBeginPlay()
{
	...
	if (GameMutator != None)
	{
		...
		`log("DKSpecialWave_FleshpoundKings: Started boss wave tracking");
	}
...
function SpawnBossGroups()
{
	...
	`log("DKSpecialWave_FleshpoundKings: Spawned 10 Fleshpound Kings in 2 groups");
}

function WaveEnded()
{
	`log("DKSpecialWave_FleshpoundKings: Wave ended");
	super.WaveEnded();
}
...
defaultproperties
{
	...
	Name="Default__DKSpecialWave_FleshpoundKings"
}