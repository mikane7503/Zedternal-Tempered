// ===================================================================
// DKFastball_PayloadMarker - "This human is currently a projectile"
//
// Spawned on the LAUNCHED teammate's pawn for the duration of the
// flight. Two jobs:
//   1. Fall damage shield: both DKGameInfos' ReduceDamage zero
...
// ===================================================================
class DKFastball_PayloadMarker extends Actor;
...
defaultproperties
{
	...
	Name="Default__DKFastball_PayloadMarker"
}
