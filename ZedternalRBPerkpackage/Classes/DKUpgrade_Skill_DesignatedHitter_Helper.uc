...
class DKUpgrade_Skill_DesignatedHitter_Helper extends Actor;
...
function PollMarker()
{
	local DKFastball_PayloadMarker M;
	...
	foreach Owner.ChildActors(class'DKFastball_PayloadMarker', M)
	{
		bHasMarker = True;
		break;
	}
	...
	else if (bMarkerSeen)
	{
		...
		bMarkerSeen = False;
		BuffEndTime = WorldInfo.TimeSeconds + class'DKUpgrade_Skill_DesignatedHitter'.default.BuffDuration;
	}
}
...
defaultproperties
{
	...
	Name="Default__DKUpgrade_Skill_DesignatedHitter_Helper"
}
