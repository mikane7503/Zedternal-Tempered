// ===================================================================
// DKUpgrade_Perk_Detonator_Helper - State machine for the Detonator perk
//
...
// ===================================================================
class DKUpgrade_Perk_Detonator_Helper extends Actor;
...
// ===================================================================
// KILL HANDLER (called from DKUpgrade_Perk_Detonator.ModifyDamageGiven)
// ===================================================================
...
function EndActiveWindow()
{
    ...
    if (Player != None && Player.Controller != None)
    {
        class'DKMessageManager'.static.SendImportantLoc(
            KFPlayerController(Player.Controller),
...
function SpawnDetonationAt(KFPawn_Monster KFPM, bool bIsBoss, int ChainDepth)
{
    ...
    Proj = Player.Spawn(class'DKProj_Detonator', Player, , SpawnLoc, SpawnRot);
    if (Proj != None)
    {
...
{
    local DKProj_DetonatorGroundFire Fire;
    ...
    Fire = Player.Spawn(class'DKProj_DetonatorGroundFire', Player, , Loc, rot(0,0,0));
    if (Fire != None)
    {
...
defaultproperties
{
    ...
    Name="Default__DKUpgrade_Perk_Detonator_Helper"
}
