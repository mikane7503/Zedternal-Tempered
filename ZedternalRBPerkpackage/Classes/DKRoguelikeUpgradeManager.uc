 ...
 */
class DKRoguelikeUpgradeManager extends Actor;
...
var array<DKPlayerController> PlayersInSelection;
var array<DKPlayerController> PlayersCompletedSelection;

struct PendingUpgradeOptions
{
    var DKPlayerController PC;
...
// Optional cap on catch-up picks (0 = unlimited). Set from DKConfig_Roguelike.
...
event PostBeginPlay()
{
    super.PostBeginPlay();
    LoadUpgradePools();
    `log("[DK_ROGUELIKE] DKRoguelikeUpgradeManager spawned and ready");
...
function LoadUpgradePools()
{
    ...
    U.UpgradeID = "UNIV_R_RESIST"; U.DisplayName = "Resilient"; U.Description = "-5% Damage Taken";
    U.Rarity = RLR_Rare; U.StatValue = 0.05; UniversalUpgrades.AddItem(U);

    U.UpgradeID = "UNIV_E_RESIST"; U.DisplayName = "Stalwart"; U.Description = "-8% Damage Taken";
    U.Rarity = RLR_Epic; U.StatValue = 0.08; UniversalUpgrades.AddItem(U);

    U.UpgradeID = "UNIV_L_RESIST"; U.DisplayName = "Unbreakable"; U.Description = "-12% Damage Taken";
    U.Rarity = RLR_Legendary; U.StatValue = 0.12; UniversalUpgrades.AddItem(U);
    ...
    U.UpgradeID = "UNIV_C_SUMO"; U.DisplayName = "Heavy Step"; U.Description = "+8% Damage Resist, -5% Speed";
    U.Rarity = RLR_Common; U.StatValue = 0.08; UniversalUpgrades.AddItem(U);

    U.UpgradeID = "UNIV_U_SUMO"; U.DisplayName = "Immovable"; U.Description = "+12% Damage Resist, -8% Speed";
    U.Rarity = RLR_Uncommon; U.StatValue = 0.12; UniversalUpgrades.AddItem(U);

    U.UpgradeID = "UNIV_R_SUMO"; U.DisplayName = "Sumo Stance"; U.Description = "+18% Damage Resist, -10% Speed";
    U.Rarity = RLR_Rare; U.StatValue = 0.18; UniversalUpgrades.AddItem(U);

    U.UpgradeID = "UNIV_E_SUMO"; U.DisplayName = "Living Wall"; U.Description = "+25% Damage Resist, -12% Speed";
    U.Rarity = RLR_Epic; U.StatValue = 0.25; UniversalUpgrades.AddItem(U);

    U.UpgradeID = "UNIV_L_SUMO"; U.DisplayName = "Unstoppable Force"; U.Description = "+35% Damage Resist, -15% Speed";
    U.Rarity = RLR_Legendary; U.StatValue = 0.35; UniversalUpgrades.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Agony"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Archangel"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Artificer"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Bulwark"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Cinder"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Cryophilite"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Daredevil"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_ForgeWarden"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Frost"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Gambit"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Gambler"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Haunted"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Headhunter"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Hivemind"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Hollow"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Hydra"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Maniac"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Medusa"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Metronome"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Omen"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Parasite"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Predator"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Pyrokinetic"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Reaper"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Riot"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Scavenger"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Shapeshifter"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_SpecialAgent"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Symbiote"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Taskmaster"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_TimeTraveler"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Tycoon"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Venomancer"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Voodoo"; PerkUniques.AddItem(U);

    U.UpgradeID = "PERK_X_WARLORD"; U.DisplayName = "Iron Curtain";
    U.Description = "Every 20 kills: +5 permanent armor (no cap). At 200+ armor: +15% damage resistance";
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Warlord"; PerkUniques.AddItem(U);
    ...
    U.RequiredPerkName = "ZedternalRBPerkpackage.DKUpgrade_Perk_Wendigo"; PerkUniques.AddItem(U);

    // === Apply admin overrides from KFZedternalUnlimited.ini ===
    // [ZedternalRBPerkpackage.DKConfig_RoguelikePool] UpgradeOverride=(...)
...
/** Apply DKConfig_RoguelikePool overrides to a pool array.
...
{
    local int i;
    local DKConfig_RoguelikePool.S_RoguelikeUpgradeOverride Override;

    // Walk backwards so we can safely remove disabled entries
    for (i = Pool.Length - 1; i >= 0; i--)
    {
        if (class'DKConfig_RoguelikePool'.static.FindOverride(Pool[i].UpgradeID, Override))
        {
...
function WarnUnmatchedOverrides(array<string> AppliedIDs)
{
    ...
    for (i = 0; i < class'DKConfig_RoguelikePool'.static.GetOverrideCount(); i++)
    {
        OverrideID = class'DKConfig_RoguelikePool'.static.GetOverrideID(i);
        if (OverrideID == "")
            continue;
...
function GenerateOptionsForPlayer(DKPlayerController DKPC)
{
...
function array<RoguelikeUpgradeData> BuildEligiblePool(byte PlayerTree, byte PlayerCharacter, ERoguelikeRarity TargetRarity, DKPlayerReplicationInfo DKPRI)
{
...
function bool HasPlayerPerk(WMPlayerReplicationInfo WMPRI, string PerkClassPath)
{
    ...
    // Check each perk slot — use ClassIsChildOf so wrappers (DKWrapper_Perk_Berserker) match
...
function bool HasPlayerUpgrade(DKPlayerReplicationInfo DKPRI, string UpgradeID)
{
    local int i;
...
function bool HasAnyEligibleUnique(DKPlayerReplicationInfo DKPRI)
{
    local int i;
...
function SendOptionsToClient(DKPlayerController DKPC, array<RoguelikeUpgradeData> Options)
{
    local int i;
    local DKPlayerReplicationInfo DKPRI;
...
function string GetAccumulatedDisplay(ERoguelikeStatType StatType, bool bIsPercentage, DKPlayerReplicationInfo DKPRI)
{
    local int IntVal;
    ...
    switch (StatType)
    {
        ...
        case RLST_Sumo:
            FloatVal = DKPRI.CachedRoguelikeArmorBonus;
            if (FloatVal != 0)
            {
                return "Armor: +" $ int(FloatVal) $ " | Spd: -" $ FormatPct(DKPRI.CachedRoguelikeSpeedPenaltyPct);
            }
            break;
...
function OnPlayerSelectedUpgrade(DKPlayerController DKPC, int OptionIndex)
{
    local DKPlayerReplicationInfo DKPRI;
    local int i;
    local RoguelikeUpgradeData SelectedUpgrade;
...
function int FindCatchUpIndex(DKPlayerController DKPC)
{
    local int i;
...
function EnqueueCatchUp(DKPlayerController DKPC)
{
...
function RegisterTestOptions(DKPlayerController TestPC, array<string> UpgradeIDs)
{
...
defaultproperties
{
    ...
    Name="Default__DKRoguelikeUpgradeManager"
}
