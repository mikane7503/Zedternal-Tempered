// ===================================================================
// DKPawn_ZedCrawler_Mini_Puppet
//
// Puppet Master controllable variant of ZR's WMPawn_ZedCrawler_Mini (Case A).
// Crawler skeleton -> reuses KFSM_PlayerCrawler_*. Control layer only.
// Stats/mesh/scale/identity stay inherited.
// ===================================================================
class DKPawn_ZedCrawler_Mini_Puppet extends WMPawn_ZedCrawler_Mini;
