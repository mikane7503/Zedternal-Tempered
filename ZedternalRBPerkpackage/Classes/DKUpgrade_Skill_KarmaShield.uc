...
class DKUpgrade_Skill_KarmaShield extends DKUpgrade_Skill
...
static function DKUpgrade_Skill_KarmaShield_Helper GetHelper(Pawn OwnerPawn)
{
	local DKUpgrade_Skill_KarmaShield_Helper H;

	if (KFPawn_Human(OwnerPawn) == None)
		return None;

	foreach OwnerPawn.ChildActors(class'DKUpgrade_Skill_KarmaShield_Helper', H)
		return H;

	return OwnerPawn.Spawn(class'DKUpgrade_Skill_KarmaShield_Helper', OwnerPawn);
}
...
defaultproperties
{
	...
	LocSection="DKUpgrade_Skill_KarmaShield"
	...
	Name="Default__DKUpgrade_Skill_KarmaShield"
}
