// ===================================================================
// DKUpgrade_Perk_Domain - "Room" perk archetype (Trafalgar-Law-like)
//
// 20-rank perk. Per rank the room grows in RADIUS and DURATION. The active
// kit (cast + 4 wheel actions + collapse burst) lives in
// DKUpgrade_Perk_Domain_Helper; the SWF wheel + hotkey wiring lives in
// DKPlayerController / DKDomainWheelMovie.
//
...
// ===================================================================
class DKUpgrade_Perk_Domain extends DKUpgrade_Perk
...
// ===================================================================
// HELPER MANAGEMENT (mirrors DKUpgrade_Perk_JekyllHyde)
// ===================================================================
static function DKUpgrade_Perk_Domain_Helper GetHelper(Pawn OwnerPawn)
{
	local DKUpgrade_Perk_Domain_Helper H;

	if (KFPawn_Human(OwnerPawn) != None)
	{
		foreach OwnerPawn.ChildActors(class'DKUpgrade_Perk_Domain_Helper', H)
			return H;

		H = OwnerPawn.Spawn(class'DKUpgrade_Perk_Domain_Helper', OwnerPawn);
	}

	return H;
}

static simulated function DKUpgrade_Perk_Domain_Helper FindHelper(Pawn OwnerPawn)
{
	local DKUpgrade_Perk_Domain_Helper H;
...
static simulated function InitiateWeapon(int upgLevel, KFWeapon KFW, KFPawn OwnerPawn)
{
	...
	if (KFPawn_Human(OwnerPawn) != None && OwnerPawn.Role == ROLE_Authority)
	{
		...
		{
			if (H.DKPC == None)
				H.Initialize(KFPawn_Human(OwnerPawn), DKPlayerController(OwnerPawn.Controller));
...
static function WaveEnd(int upgLevel, KFPlayerController KFPC)
{
	...
	if (KFPC != None && KFPC.Pawn != None)
	{
		...
		{
			if (H.DKPC == None)
				H.Initialize(KFPawn_Human(KFPC.Pawn), DKPlayerController(KFPC));
			H.SetPerkLevel(upgLevel);
		}
	}
}
...
defaultproperties
{
	...
	UpgradeIcon(1)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_1'
	UpgradeIcon(2)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_2'
	UpgradeIcon(3)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_3'
	UpgradeIcon(4)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_4'
	UpgradeIcon(5)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(6)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(7)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(8)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(9)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(10)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(11)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(12)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(13)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(14)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(15)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(16)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(17)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(18)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(19)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'
	UpgradeIcon(20)=Texture2D'ZedternalRBPerkpackage_Resources.Perks.UI_Perk_Domain_Rank_5'

	Name="Default__DKUpgrade_Perk_Domain"
}
