// ===================================================================
// DKUI_Menu - DK fork of ZedternalReborn's WMUI_Menu (trader upgrade menu)
//
// Thin subclass: identical to WMUI_Menu in every respect EXCEPT that it
// rebinds the InventoryMenu Flash widget to DKUI_UPGMenu instead of
// WMUI_UPGMenu. DKUI_UPGMenu uses the paged perk helpers (GetPerkLevel /
...
// ===================================================================
class DKUI_Menu extends WMUI_Menu;
...
defaultproperties
{
	...
	WidgetBindings.Add((WidgetName="InventoryMenu",WidgetClass=Class'ZedternalRBPerkpackage.DKUI_UPGMenu'))
