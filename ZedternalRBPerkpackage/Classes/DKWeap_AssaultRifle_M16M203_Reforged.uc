class DKWeap_AssaultRifle_M16M203_Reforged extends WMWeap_AssaultRifle_M16M203;
...
defaultproperties
{
	...
	AmmoPickupScale(1)=1
	WeaponProjectiles(ALTFIRE_FIREMODE)=class'ZedternalRBPerkpackage.DKProj_HighExplosive_M16M203_Reforged'
