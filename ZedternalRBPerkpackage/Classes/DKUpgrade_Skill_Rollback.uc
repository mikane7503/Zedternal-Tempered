...
class DKUpgrade_Skill_Rollback extends DKUpgrade_Skill
...
static function DKUpgrade_Skill_Rollback_Helper GetHelper(Pawn OwnerPawn)
{
	local DKUpgrade_Skill_Rollback_Helper H;

	if (KFPawn_Human(OwnerPawn) == None)
		return None;

	foreach OwnerPawn.ChildActors(class'DKUpgrade_Skill_Rollback_Helper', H)
		return H;

	return OwnerPawn.Spawn(class'DKUpgrade_Skill_Rollback_Helper', OwnerPawn);
}
...
defaultproperties
{
	...
	LocSection="DKUpgrade_Skill_Rollback"
	...
	Name="Default__DKUpgrade_Skill_Rollback"
}
