...
//   - No changes needed to existing DK skill files beyond changing extends to DKUpgrade_Skill
...
class DKUpgrade_Skill extends WMUpgrade_Skill
	abstract;
...
//   LocSection="DKUpgrade_Skill_<Name>"
...
static function string GetUpgradeDescription(bool bDeluxe)
{
	...
	return class'DKLocalizationHelper'.static.TryLocalize(default.LocPackage, default.LocSection, KeyName, Fallback);
}
