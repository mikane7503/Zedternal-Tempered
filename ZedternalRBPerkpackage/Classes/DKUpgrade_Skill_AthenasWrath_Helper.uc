class DKUpgrade_Skill_AthenasWrath_Helper extends Info
    transient;
...
function TrackAttacker(KFPawn_Monster Attacker, int SkillLevel)
{
    ...
    else
    {
        ...
        if (KFPC != None)
        {
            ...
            class'DKMessageManager'.static.SendMinor(KFPC, "Athena's Wrath: " $ Attacker.GetLocalizedName() $ " marked for revenge!");
        }
    }
}
...
defaultproperties
{
    ...
    Name="Default__DKUpgrade_Skill_AthenasWrath_Helper"
}