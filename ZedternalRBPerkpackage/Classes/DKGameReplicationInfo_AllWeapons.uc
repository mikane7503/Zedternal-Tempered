// ===================================================================
// DKGameReplicationInfo_AllWeapons - All Weapons mode variant
// Extends DKGameReplicationInfo to inherit character selection system
...
// ===================================================================
class DKGameReplicationInfo_AllWeapons extends DKGameReplicationInfo;
...
simulated function bool IsItemAllowed(STraderItem Item)
{
    ...
    // DKGameReplicationInfo.IsItemAllowed.
...
defaultproperties
{
    Name="Default__DKGameReplicationInfo_AllWeapons"
}
