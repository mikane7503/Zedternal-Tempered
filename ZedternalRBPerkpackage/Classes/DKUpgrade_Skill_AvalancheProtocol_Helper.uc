class DKUpgrade_Skill_AvalancheProtocol_Helper extends Info
    transient;
...
function OnEnemyKilled(KFPawn_Monster KilledEnemy)
{
    ...
    DamageAmount = class'DKUpgrade_Skill_AvalancheProtocol'.default.AvalancheDamage[UpgradeLevel - 1];
...
defaultproperties
{
    ...
    Name="Default__DKUpgrade_Skill_AvalancheProtocol_Helper"
}