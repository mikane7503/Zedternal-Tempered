class DKUpgrade_Skill_Metamorphosis extends DKUpgrade_Skill
...
{
    local DKUpgrade_Skill_Metamorphosis_Helper MetaHelper;
...
static simulated function InitiateWeapon(int upgLevel, KFWeapon KFW, KFPawn OwnerPawn)
{
    ...
    {
        bFound = False;
        foreach OwnerPawn.ChildActors(class'DKUpgrade_Skill_Metamorphosis_Helper', MetaHelper)
        {
            bFound = True;
            break;
        }
        ...
        if (!bFound)
        {
            MetaHelper = OwnerPawn.Spawn(class'DKUpgrade_Skill_Metamorphosis_Helper', OwnerPawn);
            MetaHelper.UpgradeLevel = upgLevel;
        }
    }
}

static function DKUpgrade_Skill_Metamorphosis_Helper GetHelper(Pawn OwnerPawn)
{
    local DKUpgrade_Skill_Metamorphosis_Helper MetaHelper;
...
defaultproperties
{
    ...
    // Section: [DKUpgrade_Skill_Metamorphosis]  -- see DKUpgrade_* base class for details.
    bShouldLocalize=True
    LocPackage="ZedternalRBPerkpackage"
    LocSection="DKUpgrade_Skill_Metamorphosis"
    ...
    Name="Default__DKUpgrade_Skill_Metamorphosis"
}