// ===================================================================
// DKConfig_PerkLimit - Limits how many DIFFERENT perks a player can own
// Lives in KFZedternalUnlimited.ini under
//   [ZedternalRBPerkpackage.DKConfig_PerkLimit]
//
...
// ===================================================================
class DKConfig_PerkLimit extends Config_Common
...
defaultproperties
{
	Name="Default__DKConfig_PerkLimit"
}
