class DKUpgrade_Skill_MementoMori_Helper extends Info
	transient;

var int WavesSurvived;

// DK: permanent max health gained from waves survived this life.
// Read by DKPerk.ModifyHealth so it survives ZR's base recompute;
...
defaultproperties
{
	...
	Name="Default__DKUpgrade_Skill_MementoMori_Helper"
}
