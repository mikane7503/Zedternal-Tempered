// ===================================================================
// DKUpgrade_Skill_GildedTouch — Artificer Skill
//
...
// Helper: DKUpgrade_Skill_GildedTouch_Helper (explosion spawning)
// ===================================================================
class DKUpgrade_Skill_GildedTouch extends DKUpgrade_Skill
...
static function ModifyDamageGiven(out int InDamage, int DefaultDamage, int upgLevel, optional Actor DamageCauser, optional KFPawn_Monster MyKFPM, optional KFPlayerController DamageInstigator, optional class<KFDamageType> DamageType, optional int HitZoneIdx, optional KFWeapon MyKFW)
{
    ...
    local DKUpgrade_Skill_GildedTouch_Helper H;
...
static function DKUpgrade_Skill_GildedTouch_Helper GetHelper(Pawn OwnerPawn, int upgLevel)
{
    local DKUpgrade_Skill_GildedTouch_Helper H;
    ...
    foreach OwnerPawn.ChildActors(class'DKUpgrade_Skill_GildedTouch_Helper', H)
    {
    ...
    {
        H = OwnerPawn.Spawn(class'DKUpgrade_Skill_GildedTouch_Helper', OwnerPawn);
        if (H != None)
            H.UpgradeLevel = upgLevel;
    }
...
defaultproperties
{
    ...
    // Section: [DKUpgrade_Skill_GildedTouch]  -- see DKUpgrade_* base class for details.
    bShouldLocalize=True
    LocPackage="ZedternalRBPerkpackage"
    LocSection="DKUpgrade_Skill_GildedTouch"
    ...
    Name="Default__DKUpgrade_Skill_GildedTouch"
}
