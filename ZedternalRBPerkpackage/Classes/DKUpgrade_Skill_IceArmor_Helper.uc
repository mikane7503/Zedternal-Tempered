class DKUpgrade_Skill_IceArmor_Helper extends Info
    transient;
...
function Timer()
{
    ...
    if ((CurrentTime - LastDamageTime) >= OutOfCombatTime && CurrentTime >= NextRegenTime)
    {
        ...
        MaxArmor = Player.MaxArmor + class'DKUpgrade_Skill_IceArmor'.default.ArmorBonus[UpgradeLevel - 1];
...
defaultproperties
{
    ...
    Name="Default__DKUpgrade_Skill_IceArmor_Helper"
}